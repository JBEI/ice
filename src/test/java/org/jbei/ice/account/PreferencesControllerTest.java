...
public class PreferencesControllerTest {
    ...
    public void testRetrieveAccountPreferences() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testRetrieveAccountPreferences", false);
    ...
    public void testRetrievePreference() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testRetrievePreference", false);
    ...
    public void testRetrieveUserPreferenceList() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testRetrieveUserPreferenceList", false);
    ...
    public void testCreatePreference() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testCreatePreference", false);
