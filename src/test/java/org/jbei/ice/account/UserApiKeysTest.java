...
public class UserApiKeysTest {
    ...
    public void testRequestKey() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("UserApiKeysTest.testRequestKey", false);
    ...
    public void testGetKeys() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("UserApiKeysTest.testGetKeys", false);
        AccountModel admin = AccountCreator.createTestAccount("UserApiKeysTest.testGetKeys.Admin", true);
    ...
    public void testDeleteKey() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("UserApiKeysTest.testDeleteKey", false);
