...
public class SampleServiceTest {
    ...
    public void testCreateSample() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("SampleServiceTest.testCreateSample", false);
    ...
    public void testDelete() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testDelete", false);
        String userId = account.getEmail();
