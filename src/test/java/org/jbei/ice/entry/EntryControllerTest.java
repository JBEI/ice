...
public class EntryControllerTest extends HibernateRepositoryTest {
    ...
    public void testMoveEntriesToTrash() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testMoveEntriesToTrash", false);
    ...
    public void testICE90() throws Exception {
        ...
        AccountModel admin = AccountCreator.createTestAccount("testICE90Admin", true);
        AccountModel user1 = AccountCreator.createTestAccount("testICE90User1", false);
        AccountModel user2 = AccountCreator.createTestAccount("testICE90User2", false);
