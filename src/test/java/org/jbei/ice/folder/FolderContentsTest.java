...
public class FolderContentsTest {
    ...
    public void testAddEntrySelection() throws Exception {
        // create account
        AccountModel account = AccountCreator.createTestAccount("FolderContentsTest.testAddEntrySelection", true);
        String userId = account.getEmail();

        AccountModel user = AccountCreator.createTestAccount("FolderContentsTest.testAddEntrySelection2", false);
    ...
    public void testGetContents() throws Exception {
        ...
        AccountModel account = AccountCreator.createTestAccount("testRetrieveFolderContents", false);
        String userId = account.getEmail();
