...
public class WebPartnersTest {
    ...
    public void testAddNewPartner() throws Exception {
        AccountModel admin = AccountCreator.createTestAccount("WebPartnersTest.testAddNewPartner", true);
    ...
    public void testUpdateAPIKey() throws Exception {
        AccountModel admin = AccountCreator.createTestAccount("WebPartnersTest.testUpdateAPIKey", true);
        String adminUser = admin.getEmail();
