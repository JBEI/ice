...
public class TransferredPartsTest {
    ...
    public void testReceiveTransferredEntry() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testReceivedTransferredEntry", false);
    ...
    private Plasmid createPlasmidObject(AccountModel owner) {
    ...
    private Strain createStrainObject(AccountModel owner) {
