...
public class GroupsTest {
    ...
    public void testAddGroup() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("GroupsTest.testAddGroup", false);
        ...
        AccountModel account1 = AccountCreator.createTestAccount("GroupsTest.testAddGroup2", false);
    ...
    public void testUpdate() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("GroupsTest.testUpdate", false);

        // create local test accounts
        AccountModel account1 = AccountCreator.createTestAccount("GroupsTest.testUpdate1", false);
        AccountModel account2 = AccountCreator.createTestAccount("GroupsTest.testUpdate2", false);
        AccountModel account3 = AccountCreator.createTestAccount("GroupsTest.testUpdate3", false);
        ...
        remoteUser1.setUser(new Account("Remote.GroupsTest.testUpdate1", ""));
        remoteUser1.setPartner(partner.toDataTransferObject());

        RemoteUser remoteUser2 = new RemoteUser();
        remoteUser2.setUser(new Account("Remote.GroupsTest.testUpdate2", ""));
        remoteUser2.setPartner(partner.toDataTransferObject());

        RemoteUser remoteUser3 = new RemoteUser();
        remoteUser3.setUser(new Account("Remote.GroupsTest.testUpdate3", ""));
