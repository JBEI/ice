...
public class GroupControllerTest {
    ...
    public void testGetGroupById() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testGetGroupById", false);
    ...
    public void testSave() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testSave", false);
    ...
    public void testCreate() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("GroupControllerTest.testCreate", false);
    ...
    public void testGetMatchingGroups() throws Exception {
        AccountModel account = AccountCreator.createTestAccount("testGetMatchingGroups", false);
        ...
        AccountModel account2 = AccountCreator.createTestAccount("testGetMatchingGroups2", false);
    ...
    public void testRetrieveGroupMembers() throws Exception {
        AccountModel a1 = AccountCreator.createTestAccount("testRetrieveGroupMembers1", false);
    ...
    public void testSetGroupMembers() throws Exception {
        AccountModel a1 = AccountCreator.createTestAccount("testSetGroupMembers1", false);
