...
public class Main {
	...
	public static void main4(String[] args) throws Exception {
		try {
			...
			Plasmid plasmid = new Plasmid(recordId, versionId, "plasmid",
					"test", "test@gmail.com", "createor",
					"createfff@asdasd.com", 0, "complete", "alias1", "kwyrod1",
					"descr1", "descr2", "references", new Date(812736817),
					new Date(132134), "bb", "ori", "prmo1", true);
