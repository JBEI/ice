...
public final class Headers {
    ...
    public static final String API_KEY_OWNER = "X-ICE-API-Token-Owner";           // optional user. system checks and uses assigned token user if not specified
    public static final String API_KEY_USER = "X-ICE-API-Token-User";           // id of owner (creator) of the API Key
