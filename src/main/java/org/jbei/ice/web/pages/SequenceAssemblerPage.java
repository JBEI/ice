...
public class SequenceAssemblerPage extends WebPage {
    public SequenceAssemblerPage(PageParameters parameters) {
        super(parameters);
    ...
    private void initialize(PageParameters parameters) {
        ...
        ResourceReference veResourceReference = new ResourceReference(UnprotectedPage.class,
                UnprotectedPage.SA_RESOURCE_LOCATION + "SequenceAssembler.swf?projectId="
