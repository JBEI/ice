    ...
    private void populateElements() {
        class PlasmidStrainForm extends StatelessForm<Object> {
            ...
            public PlasmidStrainForm(String id) {
                ...
                add(new TextField<String>("plasmidNames").setRequired(true).setLabel(
                        new Model<String>("Plasmid Name")));
                ...
                add(new TextField<String>("plasmidCreatorEmail").setLabel(new Model<String>(
                        "Creator's Email")));
                ...
                add(new DropDownChoice<CustomChoice>("plasmidBioSafetyLevel",
                        ...
                        bioSafetyChoices, new ChoiceRenderer<CustomChoice>("name", "value")));

                add(new TextArea<String>("plasmidIntellectualProperty"));
                add(new TextField<String>("plasmidFundingSource"));
                add(new TextField<String>("plasmidPrincipalInvestigator").setRequired(true)
                        .setLabel(new Model<String>("Principal Investigator")));
                ...
                add(new TextField<String>("strainNames").setRequired(true).setLabel(
                        new Model<String>("Strain Number")));
                ...
                add(new TextArea<String>("strainSummary").setRequired(true).setLabel(
            ...
            protected void onSubmit() {
                ...
                try {
                    ...
                    String plasmidPartNumberString = "[[jbei:"
                            + plasmid.getPartNumbers().toArray(new PartNumber[0])[0]
                                    .getPartNumber() + "]]";
                    strain.setPlasmids(plasmidPartNumberString);
                    AuthenticatedEntryManager
                            .createStrain(strain, IceSession.get().getSessionKey());
