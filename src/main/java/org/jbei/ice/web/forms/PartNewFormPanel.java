	...
	private void populateElements() {
		class PartForm extends StatelessForm<Object> {
			...
			public PartForm(String id) {
				...
				Set<EntryFundingSource> entryFundingSources = part
				...
				CustomChoice nonePackage = new CustomChoice(JbeiConstants
						.getPackageFormat(""), "");
				...
				add(new DropDownChoice<CustomChoice>("packageFormat",
						...
						packageFormatChoices, new ChoiceRenderer<CustomChoice>(
								"name", "value")));
			...
			protected void onSubmit() {
				try {
					...
					part.setSelectionMarkers(selectionMarkersField
							.getItemsAsSet());
				...
				part
						.setVisibility(Integer.parseInt(getVisibility()
								.getValue()));
				...
				part.setBioSafetyLevel(Integer.parseInt(getBioSafetyLevel()
						.getValue()));
