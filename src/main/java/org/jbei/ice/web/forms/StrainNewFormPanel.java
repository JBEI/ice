	...
	private void populateElements() {
		class StrainForm extends StatelessForm<Object> {
			...
			public StrainForm(String id) {
				...
				Set<EntryFundingSource> entryFundingSources = strain
			...
			protected void onSubmit() {
				...
				strain.setVisibility(Integer.parseInt(getVisibility()
						.getValue()));
				...
				strain.setBioSafetyLevel(Integer.parseInt(getBioSafetyLevel()
						.getValue()));
