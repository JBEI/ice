...
public class WorkspaceTablePanel extends SortableDataTablePanel<Workspace> {
    ...
    public WorkspaceTablePanel(String id) {
        ...
        WorkspaceDataProvider data = new WorkspaceDataProvider(IceSession.get().getAccount());
        dataProvider = data;
