...
public class MiniSampleViewPanel extends Panel {
    ...
    public MiniSampleViewPanel(String id, Entry entry) {
        super(id);
        ...
        class AddSampleLink extends AjaxFallbackLink<Object> {
            ...
            public void onClick(AjaxRequestTarget target) {
                MiniSampleViewPanel thisPanel = (MiniSampleViewPanel) getParent();
