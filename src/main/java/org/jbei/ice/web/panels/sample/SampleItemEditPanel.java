...
public class SampleItemEditPanel extends Panel {
    ...
    public SampleItemEditPanel(String id, Sample passedSample, boolean isEditAction) {
        ...
        class SampleEditForm extends StatelessForm<Object> {
            ...
            private SampleItemEditPanel controllingPanel = null;
            ...
            public SampleEditForm(String id, boolean isEditAction) {
                ...
                setControllingPanel((SampleItemEditPanel) getParent());
            ...
            public void setControllingPanel(SampleItemEditPanel controllingPanel) {
                this.controllingPanel = controllingPanel;
            }

            @SuppressWarnings("unused")
            public SampleItemEditPanel getControllingPanel() {
