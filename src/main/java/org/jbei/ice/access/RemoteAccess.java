...
public class RemoteAccess {
    ...
    public AccessPermission add(RegistryPartner partner, AccessPermission accessPermission) {
        ...
        Account accountTransfer = accessPermission.getAccount();
    ...
    public Account getRemoteUser(long remoteId, String email) {
        ...
        return client.get("rest/users/" + email, Account.class);
    }
    ...
    private Permission createPermissionModel(AccessPermission accessPermission, Folder folder, AccountModel account) {
