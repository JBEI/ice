...
public class GroupManager extends Manager{
	...
	public static Group create(String uuid, String label, String description, Group parent) throws ManagerException {
		Group g = new Group();
		g.setUuid(uuid);
		g.setLabel(label);
	...
	public static Group create(String label, String description, Group parent) throws ManagerException {
	...
	public static Group update(Group group) throws ManagerException {
		try {
			...
			e.printStackTrace();
			String msg = "Could not save group " + group.getLabel() + " to database: " + e.toString();
			Logger.error(msg);
			throw new ManagerException(msg);
