 ...
 */
public class StorageDAO extends HibernateRepository {
    ...
    public List<Storage> retrieveStorageByIndex(String index, StorageType type)
            throws DAOException {
    ...
    public List<Storage> getStorageSchemesForEntryType(String entryType) throws DAOException {
        ...
        switch (type) {
            ...
            case ARABIDOPSIS:
                uuid = configurationDAO.get(ConfigurationKey.ARABIDOPSIS_STORAGE_ROOT)
                                       .getValue();
                break;
        }
     ...
     * @throws ManagerException
     */
    private Storage getOrCreateChildLocation(Storage template, String itemLabel,
            Storage parent) throws DAOException {
     ...
     * @throws ManagerException
     */
    public Storage retrieveStorageBy(String name, String index, StorageType type,
