...
import org.jbei.ice.dto.entry.PartSource;
import org.jbei.ice.dto.entry.PartWithSequence;
...
public class WebEntries {
    ...
    private static class WebEntriesIterator implements Iterator<PartWithSequence> {
        private final List<RemotePartner> partners;
        private final List<PartWithSequence> parts;
