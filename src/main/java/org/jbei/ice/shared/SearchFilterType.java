...
public enum SearchFilterType {
    ...
    CHOOSE("Choose One", "", false), NAME_OR_ALIAS("Name or Alias", "name", true), PART_NUMBER(
            ...
            "Bio Safety Level", "", false), INTELLECTUAL_PROPERTY("Intellectual Property", "", false), PRINCIPAL_INVESTIGATOR(
            "Principal Investigator", "", false), FUNDING_SOURCE("Funding Source", "", false), SELECTION_MARKER(
    ...
    SearchFilterType(String displayName, String shortName, boolean isComposite, SearchFilterType... constraints) {
