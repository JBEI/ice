...
import org.jbei.ice.parsers.ABIParser;
...
import org.jbei.ice.search.blast.BlastPlus;
...
public class PartTraceSequences {
    ...
    public Results<TraceSequenceAnalysis> getTraces(int start, int limit) {
        ...
        for (TraceSequence traceSequence : sequences) {
            ...
            AccountModel account = DAOFactory.getAccountDAO().getByEmail(traceSequence.getDepositor());
