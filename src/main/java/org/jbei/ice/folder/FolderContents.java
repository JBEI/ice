...
import org.jbei.ice.entry.EntrySelectionType;
...
public class FolderContents {
    ...
    private final FolderDAO folderDAO = DAOFactory.getFolderDAO();
    private final RemoteAccessModelDAO remoteAccessModelDAO = DAOFactory.getRemoteAccessModelDAO();
    private final FolderAuthorization folderAuthorization = new FolderAuthorization();
    private final PermissionsController permissionsController = new PermissionsController();
    private final AccountController accountController = new AccountController();
    private final RemoteContact remoteContact = new RemoteContact();
    private final PermissionDAO permissionDAO = DAOFactory.getPermissionDAO();
    ...
    private void addToRemoteFolder(AccountModel account, Folder folder, List<Long> entries) {
    ...
    public FolderDetails getContents(String userId, long folderId, PageParameters pageParameters, List<String> fields) {
        ...
        AccountModel owner = DAOFactory.getAccountDAO().getByEmail(folder.getOwnerEmail());
        if (owner != null)
