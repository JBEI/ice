...
import org.jbei.ice.dto.search.BlastProgram;
import org.jbei.ice.logging.Logger;
import org.jbei.ice.parsers.bl2seq.Bl2SeqResult;
...
public class BlastPlus {
    ...
    public void formatBlastDb(BlastFastaFile fastaFile, String dbName) throws BlastException {
        ...
        String makeBlastDbCmd = getBlastInstallDirectory().toAbsolutePath() + File.separator + "makeblastdb";
...
//        commands.add("ICE Blast DB");
        ...
        try {
            ...
            throw new BlastException("Could not run makeblastdb [BlastDBPath is " + getBlastInstallDirectory() + "]", e);
        } catch (IOException e) {
            throw new BlastException(e);
        }
    }
