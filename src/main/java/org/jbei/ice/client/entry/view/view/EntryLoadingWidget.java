...
public class EntryLoadingWidget extends Composite {
    ...
    public EntryLoadingWidget() {
        //        String html = "<div>"
        //                + "<div style=\"position:absolute; z-index:2147483647; text-align: center; width:600px; color:#FFF;\">"
        //                + "<div style=\"font-size:30px; font-weight:bold;\">LOADING...</div>"
        //                + "<div style=\"position:absolute;z-index:2147483646; width: 100%; height: 100%; filter:alpha(opacity=60);opacity:0.6; background-color:#FFF;\"></div>"
        //                + "</div>";
