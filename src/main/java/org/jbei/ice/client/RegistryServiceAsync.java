...
public interface RegistryServiceAsync {
    ...
    // Search
    //
    void retrieveSearchResults(String sid, ArrayList<SearchFilterInfo> filters, EntryType[] types,
            ColumnField sort, boolean asc, int start, int limit, AsyncCallback<SearchResults> async);
