...
public class DAOFactory {
    ...
    private static EntryFieldValueModelDAO entryFieldValueModelDAO;
    ...
    public static SequenceHistoryDAO getSequenceHistoryDAO() {
        if (sequenceHistoryDAO == null)
            sequenceHistoryDAO = new SequenceHistoryDAO();
        return sequenceHistoryDAO;
    }

    public static SequenceHistoryModelDAO getSequenceHistoryModelDAO() {
    ...
    public static SampleCreateModelDAO getSampleCreateModelDAO() {
    ...
    public static EntryFieldValueModelDAO getEntryFieldValueModelDAO() {
        if (entryFieldValueModelDAO == null)
            entryFieldValueModelDAO = new EntryFieldValueModelDAO();
        return entryFieldValueModelDAO;
    }
}
