...
Handsontable.plugins = {}, function (a, b) {
    "use strict";
    function c() {
    ...
    function d() {
        function a() {
            ...
            a._registerTimeout(setTimeout(function () {
                a.updateSettings({observeChanges: !0})
            }, 0))
        }
        ...
        this.init = function (b) {
            var c, d, e = this, g = e.getSettings().columnSorting;
        ...
        this.sort = function () {
            ...
            var b = this;
            if (b.sortingEnabled && b.sortIndex && b.sortIndex.length)for (var c = 0; c < b.sortIndex.length; c++)if (b.sortIndex[c][0] == a)return c
            ...
            var b = this, c = !1, d = {};
            if (a) {
                for (var e = 0; e < a.length; e++)if (a[e][1] == b.sortColumn) {
    ...
    function e(a) {
        var c = b.eventManager(a), d = function (a, b, c, d) {
            ...
            var e = a.view.wt.wtTable.getCell(c.from), f = b.Dom.offset(e), h = a.getColWidth(c.from.col);
            ...
            if (-1 != c.target.className.indexOf("htCommentCell")) {
                h();
                var d = a.view.wt.wtTable.getCoords(c.target), e = {from: new l(d.row, d.col)};
        ...
        return {
            init: function () {
                ...
                var c = a.getCellMeta(b.from.row, b.from.col), d = "";
                ...
                var b = !1, c = a.getSelectedRange().from;
    ...
    function f(b) {
        var c, d = function () {
            ...
            var d = a.localStorage[b + "__persistentStateKeys"], e = "string" == typeof d ? JSON.parse(d) : void 0;
            c = e ? e : []
        }, f = function () {
            c = [], d()
        };
    ...
    function i(a) {
        if (this.mergedCellInfoCollection = new h, Array.isArray(a))for (var b = 0, c = a.length; c > b; b++)this.mergedCellInfoCollection.setInfo(a[b])
    }
    ...
    function k(a, c) {
        ...
        if (c) {
            ...
            for (var g = ["top", "left", "bottom", "right", "corner"], h = 0; 5 > h; h++) {
                var i = g[h], j = document.createElement("DIV");
    ...
    function o(a, b, c, d) {
        var e, f = 0;
        for (this.instance = a, this.containerSizeFn = b, this.cellSizesSum = 0, this.cellSizes = [], this.cellStretch = [], this.cellCount = 0, this.visibleCellCount = 0, this.remainingSize = 0, this.strategy = d; ;) {
            if (e = c(f), void 0 === e)break;
            this.cellSizesSum < this.getContainerSize() && this.visibleCellCount++, this.cellSizes.push(e), this.cellSizesSum += e, this.cellCount++, f++
        }
    ...
    function r(c) {
        var d = this, e = b.eventManager(c);
        this.instance = c;
        var f = [null, null];
        this.dblClickTimeout = [null, null];
        var g, h, i = function (a) {
            var c = d.parentCell(a.target);
            b.Dom.hasClass(a.target, "corner") ? d.instance.getSetting("onCellCornerMouseDown", a, a.target) : c.TD && d.instance.hasSetting("onCellMouseDown") && d.instance.getSetting("onCellMouseDown", a, c.coords, c.TD, d.instance), 2 !== a.button && c.TD && (f[0] = c.TD, clearTimeout(d.dblClickTimeout[0]), d.dblClickTimeout[0] = setTimeout(function () {
                f[0] = null
            }, 1e3))
        }, j = function () {
            ...
            if (d.instance.hasSetting("onCellMouseOver")) {
                var c = d.instance.wtTable.TABLE, e = b.Dom.closest(a.target, ["TD", "TH"], c);
                e && e !== h && b.Dom.isChildOf(e, c) && (h = e, d.instance.getSetting("onCellMouseOver", a, d.instance.wtTable.getCoords(e), e, d.instance))
            }
        }, m = function (a) {
            if (2 !== a.button) {
                var c = d.parentCell(a.target);
                c.TD === f[0] && c.TD === f[1] ? (b.Dom.hasClass(a.target, "corner") ? d.instance.getSetting("onCellCornerDblClick", a, c.coords, c.TD, d.instance) : d.instance.getSetting("onCellDblClick", a, c.coords, c.TD, d.instance), f[0] = null, f[1] = null) : c.TD === f[0] && (f[1] = c.TD, clearTimeout(d.dblClickTimeout[1]), d.dblClickTimeout[1] = setTimeout(function () {
                    f[1] = null
                }, 500))
            }
        }, n = function (a) {
        ...
        if (e.addEventListener(this.instance.wtTable.holder, "mousedown", i), e.addEventListener(this.instance.wtTable.TABLE, "mouseover", l), e.addEventListener(this.instance.wtTable.holder, "mouseup", m), this.instance.wtTable.holder.parentNode.parentNode && b.mobileBrowser) {
            var o = "." + this.instance.wtTable.holder.parentNode.className.split(" ").join(".");
            e.addEventListener(this.instance.wtTable.holder.parentNode.parentNode, "touchstart", function (a) {
                d.instance.touchApplied = !0, b.Dom.isChildOf(a.target, o) && k.call(a.target, a)
            }), e.addEventListener(this.instance.wtTable.holder.parentNode.parentNode, "touchend", function (a) {
                d.instance.touchApplied = !1, b.Dom.isChildOf(a.target, o) && n.call(a.target, a)
            }), d.instance.momentumScrolling || (d.instance.momentumScrolling = {}), e.addEventListener(this.instance.wtTable.holder.parentNode.parentNode, "scroll", function () {
    ...
    function y(a) {
        this.instance = a, a.update("scrollbarWidth", b.Dom.getScrollbarWidth()), a.update("scrollbarHeight", b.Dom.getScrollbarWidth()), this.vertical = new x(a), this.horizontal = new w(a), this.corner = new v(a), a.getSetting("debug") && (this.debug = new q(a)), this.registerListeners()
    }
    ...
    function A(a, c) {
        ...
        for (var e in this.defaults)if (this.defaults.hasOwnProperty(e))if (void 0 !== c[e])this.settings[e] = c[e]; else {
    ...
    function C(a) {
        this.wtTable = a, this.instance = a.instance, this.rowFilter = a.rowFilter, this.columnFilter = a.columnFilter, this.TABLE = a.TABLE, this.THEAD = a.THEAD, this.TBODY = a.TBODY, this.COLGROUP = a.COLGROUP, this.utils = C.utils
    }
    ...
    function E(a, b, c, d, e, f, g) {
        ...
        var j, k, l, m = this, n = 1, o = 0, p = !0, q = 50, r = [];
        ...
        }, l = 0; c > l; l++)if (k = j(l), b >= o && !f && (this.startColumn = l), o >= b && b + a >= o + k && (null == this.startColumn && (this.startColumn = l), this.endColumn = l), r.push(o), o += k, f || (this.endColumn = l), o >= b + a) {
            p = !1;
            break
        }
        if (this.endColumn == c - 1 && p)for (this.startColumn = this.endColumn; this.startColumn > 0;) {
    ...
    function F(a, b, c, d, e, f) {
        ...
        for (var g, h = 0, i = !0, j = 23, k = [], l = 0; c > l; l++)if (g = d(l), void 0 === g && (g = j), b >= h && !f && (this.startRow = l), h >= b && b + a >= h + g && (null == this.startRow && (this.startRow = l), this.endRow = l), k.push(h), h += g, f || (this.endRow = l), h >= b + a) {
            i = !1;
            break
        }
        if (this.endRow == c - 1 && i)for (this.startRow = this.endRow; this.startRow > 0;) {
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function (a) {
        ...
        var e = +new Date % 1e9, f = function () {
            this.name = "__st" + (1e9 * Math.random() >>> 0) + (e++ + "__"), c || (this._wmCache = [])
        };
        f.prototype = c ? {
            set: function (a, c) {
                var d = a[this.name];
                d && d[0] === a ? d[1] = c : b(a, this.name, {value: [a, c], writable: !0})
            }, get: function (a) {
                var b;
            ...
            set: function (a, b) {
                if ("undefined" != typeof a && "undefined" != typeof b) {
                    for (var c = 0, d = this._wmCache.length; d > c; c++)if (this._wmCache[c].key == a)return void(this._wmCache[c].value = b);
                    this._wmCache.push({key: a, value: b})
                }
            }, get: function (a) {
                if ("undefined" != typeof a)for (var b = 0, c = this._wmCache.length; c > b; b++)if (this._wmCache[b].key == a)return this._wmCache[b].value
            }, "delete": function (a) {
                if ("undefined" != typeof a)for (var b = 0, c = this._wmCache.length; c > b; b++)this._wmCache[b].key == a && Array.prototype.slice.call(this._wmCache, b, 1)
            }
        }, a.WeakMap = f
        ...
        function e(a, c, e) {
            ...
            var g = new d;
            g.onQueueEmpty = f;
            for (var h = a.length - 1; h >= 0; h--)if (null === a[h])a.splice(h, 1); else {
                var i = a[h][0], j = o.propToCol(a[h][1]), k = s.runHooks("modifyCol", j), l = s.getCellMeta(i, k);
        ...
        function f(a, c) {
            var d = a.length - 1;
            if (!(0 > d)) {
                for (; d >= 0; d--)if (null !== a[d]) {
                    if (null != a[d][2] || null != a[d][3]) {
                        if (n.settings.allowInsertRow)for (; a[d][0] > s.countRows() - 1;)o.createRow();
                        if ("array" === s.dataType && n.settings.allowInsertColumn)for (; o.propToCol(a[d][1]) > s.countCols() - 1;)o.createCol();
        ...
        function h(a) {
            if (a.hasOwnProperty("type")) {
                var c, d = {};
                if ("object" == typeof a.type)c = a.type; else if ("string" == typeof a.type && (c = b.cellTypes[a.type], void 0 === c))throw new Error('You declared cell type "' + a.type + '" as a string that is not mapped to a known object. Cell type must be an object or a string mapped to an object in Handsontable.cellTypes');
        ...
        b.helper.extend(t.prototype, G.prototype), b.helper.extend(t.prototype, c), b.helper.extend(t.prototype, h(c)), this.rootElement = a, this.container = document.createElement("DIV"), this.container.className = "htContainer", a.insertBefore(this.container, a.firstChild), this.guid = "ht_" + b.helper.randomString(), this.rootElement.id && "ht_" !== this.rootElement.id.substring(0, 3) || (this.rootElement.id = this.guid), n = {
            ...
            alter: function (a, b, c, d, e) {
                ...
                var a, b, c, d;
                if (b = s.countRows(), b < n.settings.minRows)for (a = 0; a < n.settings.minRows - b; a++)o.createRow(s.countRows(), 1, !0);
                if (c = s.countEmptyRows(!0), c < n.settings.minSpareRows)for (; c < n.settings.minSpareRows && s.countRows() < n.settings.maxRows; c++)o.createRow(s.countRows(), 1, !0);
                if (d = s.countEmptyCols(!0), !n.settings.columns && s.countCols() < n.settings.minCols)for (; s.countCols() < n.settings.minCols; d++)o.createCol(s.countCols(), 1, !0);
                if (!n.settings.columns && "array" === s.dataType && d < n.settings.minSpareCols)for (; d < n.settings.minSpareCols && s.countCols() < n.settings.maxCols; d++)o.createCol(s.countCols(), 1, !0);
                var e = s.countRows(), f = s.countCols();
                if ((0 === e || 0 === f) && q.deselect(), q.isSelected()) {
                    var g, h = n.selRange.from.row, i = n.selRange.from.col, j = n.selRange.to.row, k = n.selRange.to.col;
                ...
                switch (f) {
                    case"shift_down":
                        for (p = d ? d.col - a.col + 1 : 0, q = d ? d.row - a.row + 1 : 0, c = b.helper.translateRowsToColumns(c), k = 0, l = c.length, r = Math.max(l, p); r > k; k++)if (l > k) {
                        ...
                        break;
                    case"shift_right":
                        for (p = d ? d.col - a.col + 1 : 0, q = d ? d.row - a.row + 1 : 0, i = 0, j = c.length, t = Math.max(j, q); t > i; i++)if (j > i) {
                        ...
                        for (-1 !== ["up", "left"].indexOf(g) ? u = {
                            ...
                            for (o.col = a.col, l = c[i] ? c[i].length : 0, k = 0; l > k && !(d && o.col > d.col || !n.settings.allowInsertColumn && o.col > s.countCols() - 1 || o.col >= n.settings.maxCols); k++) {
                                if (!s.getCellMeta(o.row, o.col).readOnly) {
                                    var w, x = c[i][k], y = {row: i, col: k};
                                    "autofill" === e && (w = s.runHooks("beforeAutofillInsidePopulate", y, g, c, h, u, v), w && (u = "undefined" != typeof w.iterators ? w.iterators : u, x = "undefined" != typeof w.value ? w.value : x)), m.push([o.row, o.col, x])
                                }
            ...
            setRangeEnd: function (a, c, d) {
                b.hooks.run(s, "beforeSetRangeEnd", a), s.selection.begin(), n.selRange.to = new l(a.row, a.col), n.settings.multiSelect || (n.selRange.from = a), s.view.wt.selections.current.clear(), s.view.wt.selections.current.add(n.selRange.highlight), s.view.wt.selections.area.clear(), q.isMultiple() && (s.view.wt.selections.area.add(n.selRange.from), s.view.wt.selections.area.add(n.selRange.to)), (n.settings.currentRowClassName || n.settings.currentColClassName) && (s.view.wt.selections.highlight.clear(), s.view.wt.selections.highlight.add(n.selRange.from), s.view.wt.selections.highlight.add(n.selRange.to)), b.hooks.run(s, "afterSelection", n.selRange.from.row, n.selRange.from.col, n.selRange.to.row, n.selRange.to.col), b.hooks.run(s, "afterSelectionByProp", n.selRange.from.row, o.colToProp(n.selRange.from.col), n.selRange.to.row, o.colToProp(n.selRange.to.col)), c !== !1 && s.view.mainViewIsActive() && s.view.scrollViewport(n.selRange.from && !q.isMultiple() ? n.selRange.from : a), q.refreshBorders(null, d)
            },
            refreshBorders: function (a, b) {
                b || r.destroyEditor(a), s.view.render(), q.isSelected() && !b && r.prepareEditor()
            },
            isMultiple: function () {
                var a = !(n.selRange.to.col === n.selRange.from.col && n.selRange.to.row === n.selRange.from.row), c = b.hooks.run(s, "afterIsMultipleSelection", a);
                return a ? c : void 0
            },
            transformStart: function (a, b, c, d) {
                ...
                var f = s.countRows(), g = s.countCols(), h = new l(n.selRange.highlight.row + e.row, n.selRange.highlight.col + e.col);
            ...
            transformEnd: function (a, b) {
                ...
                var d = s.countRows(), e = s.countCols(), f = new l(n.selRange.to.row + c.row, n.selRange.to.col + c.col);
            ...
            empty: function () {
                if (q.isSelected()) {
                    var a, b, c = n.selRange.getTopLeftCorner(), d = n.selRange.getBottomRightCorner(), e = [];
                    for (a = c.row; a <= d.row; a++)for (b = c.col; b <= d.col; b++)s.getCellMeta(a, b).readOnly || e.push([a, b, ""]);
                    s.setDataAtCell(e)
                }
            }
        }, this.init = function () {
            ...
            var f = s.getCellValidator(c);
            "[object RegExp]" === Object.prototype.toString.call(f) && (f = function (a) {
                return function (b, c) {
                    c(a.test(b))
                }
            }(f)), "function" == typeof f ? (a = b.hooks.run(s, "beforeValidate", a, c.row, c.prop, e), s._registerTimeout(setTimeout(function () {
                f.call(c, a, function (f) {
                    f = b.hooks.run(s, "afterValidate", f, a, c.row, c.prop, e), c.valid = f, d(f), b.hooks.run(s, "postAfterValidate", f, a, c.row, c.prop, e)
                })
            }, 0))) : (c.valid = !0, d(!0))
        }, this.setDataAtCell = function (a, b, c, d) {
            var h, i, j, k = g(a, b, c), l = [];
            ...
            if ("undefined" != typeof a.cell)for (d in a.cell) {
                var i = a.cell[d];
            ...
            j && (s.rootElement.style.overflow = "auto"), c || b.hooks.run(s, "afterUpdateSettings"), p.adjustRowsAndCols(), s.view && !n.firstRun && (s.forceFullRender = !0, q.refreshBorders(null, !0))
        ...
        this.getCellRenderer = function (a, c) {
            ...
            for (var a = 0, b = s.countCols(); b > a; a++)if (s.getColHeader(a))return !0;
            return !1
            ...
            var b = s.getCellMeta(0, a), c = b.width;
            ...
            for (var c, d = s.countRows() - 1, e = 0; d >= 0;) {
                if (c = b.hooks.run(this, "modifyRow", d), s.isEmptyRow(c))e++; else if (a)break;
                d--
            }
            return e
            ...
            for (var b = s.countCols() - 1, c = 0; b >= 0;) {
                if (s.isEmptyCol(b))c++; else if (a)break;
                b--
            }
            return c
    ...
    if (G.prototype = {
            ...
            isEmptyRow: function (a) {
                for (var b, c = 0, d = this.countCols(); d > c; c++)if (b = this.getDataAtCell(a, c), "" !== b && null !== b && "undefined" != typeof b)return !1;
                return !0
            },
            isEmptyCol: function (a) {
                for (var b, c = 0, d = this.countRows(); d > c; c++)if (b = this.getDataAtCell(c, a), "" !== b && null !== b && "undefined" != typeof b)return !1;
                return !0
            },
            ...
            renderer: void 0,
            format: void 0
        }, b.DefaultSettings = G, function (a) {
            function b() {
                function a(a) {
                ...
                var d = {arrayMap: [], weakMap: new WeakMap};
                return {
                    get: function (c) {
    ...
    if (b.Dom = {}, b.Dom.enableImmediatePropagation = function (a) {
            ...
            for (; null != a && a !== c;) {
                if (1 === a.nodeType && b.indexOf(a.nodeName) > -1)return a;
                a = a.parentNode
            }
            return null
            ...
            return b
        }, document.documentElement.classList ? (b.Dom.hasClass = function (a, b) {
            ...
            "" === a.className ? a.className = b : this.hasClass(a, b) || (a.className += " " + b)
        }, b.Dom.removeClass = function (a, b) {
            if (this.hasClass(a, b)) {
                var c = new RegExp("(\\s|^)" + b + "(\\s|$)");
                a.className = a.className.replace(c, " ").trim()
            }
        }), b.Dom.removeTextNodes = function (a, b) {
            if (3 === a.nodeType)b.removeChild(a); else if (["TABLE", "THEAD", "TBODY", "TFOOT", "TR"].indexOf(a.nodeName) > -1)for (var c = a.childNodes, d = c.length - 1; d >= 0; d--)this.removeTextNodes(c[d], a)
            ...
            function c(a) {
                return "undefined" != typeof ShadowDOMPolyfill && ShadowDOMPolyfill.unwrapIfNeeded ? ShadowDOMPolyfill.unwrapIfNeeded(a) : a
            }

            for (var d = a; c(d) !== document.documentElement;) {
                if (null === d)return !1;
                if (11 === d.nodeType) {
                    if (d.host) {
                        if (d.host.impl)return b.Dom.isVisible(d.host.impl);
                        if (d.host)return b.Dom.isVisible(d.host);
            ...
            for (c = b.offsetLeft, d = b.offsetTop, e = b; (b = b.offsetParent) && b !== document.body;)c += b.offsetLeft, d += b.offsetTop, e = b;
            ...
            for (var c, d, e, f = b.parentNode, g = ["auto", "scroll"]; f && f.style;) {
                if (c = f.style.overflow, d = f.style.overflowX, e = f.style.overflowY, "scroll" == c || "scroll" == d || "scroll" == e)return f;
                if (f.clientHeight < f.scrollHeight && (-1 !== g.indexOf(e) || -1 !== g.indexOf(c)))return f;
                if (f.clientWidth < f.scrollWidth && (-1 !== g.indexOf(d) || -1 !== g.indexOf(c)))return f;
                f = f.parentNode
            }
            return a
            ...
            b.Dom.hasCaptionProblem = function () {
                ...
                if (void 0 === c && (c = b), a.setSelectionRange)a.focus(), a.setSelectionRange(b, c); else if (a.createTextRange) {
                    var d = a.createTextRange();
                    d.collapse(!0), d.moveEnd("character", c), d.moveStart("character", b), d.select()
                }
            };
            var e;
            b.Dom.getScrollbarWidth = function () {
    ...
    b.countEventManagerListeners = 0, b.eventManager = function (c) {
        ...
        return c.eventListeners || (c.eventListeners = []), d = function (d, f, g) {
            var h;
            return h = function (a) {
                var c;
                void 0 == a.target && void 0 != a.srcElement && (a.definePoperty ? a.definePoperty("target", {value: a.srcElement}) : a.target = a.srcElement), void 0 == a.preventDefault && (a.definePoperty ? a.definePoperty("preventDefault", {
                    value: function () {
                        this.returnValue = !1
                    }
                }) : a.preventDefault = function () {
                    this.returnValue = !1
                }), a.realTarget = a.target, a.isTargetWebComponent = !1, b.helper.isWebComponent(a.target) ? (a.isTargetWebComponent = !0, c = Object.create(a, {
                    target: {value: a.path[0]},
                    constructor: {value: a.constructor}
                }), c.preventDefault = function () {
                    a.preventDefault.apply(a, arguments)
                }, c.stopPropagation = function () {
                    a.stopPropagation.apply(a, arguments)
                }, c.stopImmediatePropagation = function () {
                    a.stopImmediatePropagation.apply(a, arguments)
                }, g.call(this, c)) : g.call(this, a)
            }, c.eventListeners.push({
                element: d,
                event: f,
                callback: g,
                callbackProxy: h
            }), a.addEventListener ? d.addEventListener(f, h, !1) : d.attachEvent("on" + f, h), b.countEventManagerListeners++, function () {
                e(d, f, g)
            }
        }, e = function (a, d, e) {
            for (var f, g = c.eventListeners.length; g--;)if (f = c.eventListeners[g], f.event == d && f.element == a) {
            ...
            for (var a, b = c.eventListeners.length; b--;)a = c.eventListeners[b], a && e(a.element, a.event, a.callback)
        }, g = function (b, c) {
            var d, e;
            d = {
                bubbles: !0,
        ...
        }, {addEventListener: d, removeEventListener: e, clear: f, fireEvent: g}
        ...
        this.isMouseDown = function () {
            ...
            var b = a.target;
            if (!g) {
                if (b !== d.instance.container)for (; b !== document.documentElement;) {
                    if (null === b) {
        ...
        }), new z({className: "fill", border: {width: 1, color: "red"}})];
        ...
        a.editors = {
            registerEditor: function (a, e) {
                ...
                var e;
                if ("function" == typeof a)d.get(a) || this.registerEditor(null, a), e = d.get(a); else {
        ...
        a.EditorManager = function (b, c, d) {
            var e, f = this, g = a.helper.keyCode, h = !1, i = a.eventManager(b), j = function () {
                function j(i) {
                    if (b.isListening() && (a.hooks.run(b, "beforeKeyDown", i), !h && (a.Dom.enableImmediatePropagation(i), !i.isImmediatePropagationStopped() && (c.lastKeyCode = i.keyCode, d.isSelected())))) {
                        var j = (i.ctrlKey || i.metaKey) && !i.altKey;
                        if (!(e.isWaiting() || a.helper.isMetaKey(i.keyCode) || j || f.isEditorOpened()))return void f.openEditor("");
                        var k = i.shiftKey ? d.setRangeEnd : d.setRangeStart;
                        switch (i.keyCode) {
                            case g.A:
                                j && (d.selectAll(), i.preventDefault(), a.helper.stopPropagation(i));
                                break;
                            case g.ARROW_UP:
                                f.isEditorOpened() && !e.isWaiting() && f.closeEditorAndSaveChanges(j), n(i.shiftKey), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.ARROW_DOWN:
                                f.isEditorOpened() && !e.isWaiting() && f.closeEditorAndSaveChanges(j), o(i.shiftKey), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.ARROW_RIGHT:
                                f.isEditorOpened() && !e.isWaiting() && f.closeEditorAndSaveChanges(j), p(i.shiftKey), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.ARROW_LEFT:
                                f.isEditorOpened() && !e.isWaiting() && f.closeEditorAndSaveChanges(j), q(i.shiftKey), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.TAB:
                                var r = "function" == typeof c.settings.tabMoves ? c.settings.tabMoves(i) : c.settings.tabMoves;
                                i.shiftKey ? d.transformStart(-r.row, -r.col) : d.transformStart(r.row, r.col, !0), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.BACKSPACE:
                            case g.DELETE:
                                d.empty(i), f.prepareEditor(), i.preventDefault();
                                break;
                            case g.F2:
                                f.openEditor(), i.preventDefault();
                                break;
                            case g.ENTER:
                                f.isEditorOpened() ? (e.state !== a.EditorState.WAITING && f.closeEditorAndSaveChanges(j), m(i.shiftKey)) : b.getSettings().enterBeginsEditing ? f.openEditor() : m(i.shiftKey), i.preventDefault(), i.stopImmediatePropagation();
                                break;
                            case g.ESCAPE:
                                f.isEditorOpened() && f.closeEditorAndRestoreOriginalValue(j), i.preventDefault();
                                break;
                            case g.HOME:
                                k(i.ctrlKey || i.metaKey ? new l(0, c.selRange.from.col) : new l(c.selRange.from.row, 0)), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.END:
                                k(i.ctrlKey || i.metaKey ? new l(b.countRows() - 1, c.selRange.from.col) : new l(c.selRange.from.row, b.countCols() - 1)), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.PAGE_UP:
                                d.transformStart(-b.countVisibleRows(), 0), i.preventDefault(), a.helper.stopPropagation(i);
                                break;
                            case g.PAGE_DOWN:
                                d.transformStart(b.countVisibleRows(), 0), i.preventDefault(), a.helper.stopPropagation(i)
                        }
                ...
                b.addHook("afterDocumentKeyDown", function (a) {
                    j(a)
                }), i.addEventListener(document.documentElement, "keydown", function (a) {
                    b.runHooks("afterDocumentKeyDown", a)
                }), b.view.wt.update("onCellDblClick", k), b.addHook("afterDestroy", function () {
                    h = !0
                })
            };
            this.destroyEditor = function (a) {
                ...
                if (e && e.isWaiting())return void this.closeEditor(!1, !1, function (a) {
                    a && f.prepareEditor()
                });
                var d = c.selRange.highlight.row, g = c.selRange.highlight.col, h = b.colToProp(g), i = b.getCell(d, g), j = b.getDataAtCell(d, g), k = b.getCellMeta(d, g), l = b.getCellEditor(k);
                e = a.editors.getEditor(l, b), e.prepare(d, g, h, i, j, k)
            }, this.isEditorOpened = function () {
                return e.isOpened()
            }, this.openEditor = function (a) {
                e.cellProperties.readOnly || e.beginEditing(a)
            }, this.closeEditor = function (a, b, c) {
                e ? e.finishEditing(a, b, c) : c && c(!1)
        ...
        var c = b.helper.keyCode, d = [c.ARROW_DOWN, c.ARROW_UP, c.ARROW_LEFT, c.ARROW_RIGHT, c.HOME, c.END, c.DELETE, c.BACKSPACE, c.F1, c.F2, c.F3, c.F4, c.F5, c.F6, c.F7, c.F8, c.F9, c.F10, c.F11, c.F12, c.TAB, c.PAGE_DOWN, c.PAGE_UP, c.ENTER, c.ESCAPE, c.SHIFT, c.CAPS_LOCK, c.ALT];
        ...
        var b, c, d, e, f = [], g = 0;
        for (b = 0, c = a.length; c > b; b++)for (d = 0, e = a[b].length; e > d; d++)d == g && (f.push([]), g++), f[d].push(a[b][d]);
        return f
        ...
        for (var c = a.length, d = a[0].length, e = 0; c > e; e++)for (var f = 0; d > f; f++)b[f] || (b[f] = []), b[f][e] = a[e][f];
        return b
        ...
        return c = "undefined" == typeof c ? !0 : c, function (e, f) {
            return function g(e) {
                if (e) {
        ...
        var c = b.Dom.getWindowScrollLeft(), d = a.clientX + c;
        return d
    }, b.helper.pageY = function (a) {
        if (a.pageY)return a.pageY;
        var c = b.Dom.getWindowScrollTop(), d = a.clientY + c;
        return d
    }, b.helper.isWebComponent = function (a) {
        return a.shadowRoot ? !0 : !1
    }, function (a) {
        a.DataMap = function (a, b, c) {
            ...
            var b;
            if (Array.isArray(a))b = []; else {
                b = {};
                for (var c in a)a.hasOwnProperty(c) && (b[c] = "object" != typeof a[c] || Array.isArray(a[c]) ? null : this.recursiveDuckSchema(a[c]))
            }
            return b
        }, a.DataMap.prototype.recursiveDuckColumns = function (a, b, c) {
            var d, e;
            if ("undefined" == typeof b && (b = 0, c = ""), "object" == typeof a && !Array.isArray(a))for (e in a)a.hasOwnProperty(e) && (null === a[e] ? (d = c + e, this.colToPropCache.push(d), this.propToColCache.set(d, b), b++) : b = this.recursiveDuckColumns(a[e], b, e + "."));
            return b
            ...
            if (d)for (a = 0, b = d.length; b > a; a++)"undefined" != typeof d[a].data && (this.colToPropCache[a] = d[a].data, this.propToColCache.set(d[a].data, a)); else this.recursiveDuckColumns(c)
            ...
            var e, f, g = this.instance.countCols(), h = 0;
            ...
            var e, f, g = this.instance.countRows(), h = this.dataSource, i = 0;
            c || (c = 1), f = b;
            ...
            var d = this.physicalRowsToLogical(b, c), e = a.hooks.run(this.instance, "beforeRemoveRow", b, c);
            if (e !== !1) {
                var f = this.dataSource, g = f.filter(function (a, b) {
            ...
            var e = 4 <= arguments.length ? [].slice.call(arguments, 3) : [], f = this.instance.getDataAtCol(b), g = f.slice(c, c + d), h = f.slice(c + d);
            ...
            var e = 4 <= arguments.length ? [].slice.call(arguments, 3) : [], f = this.instance.getSourceDataAtRow(b), g = f.slice(c, c + d), h = f.slice(c + d);
            a.helper.extendArray(e, h);
            for (var i = 0; d > i;)e.push(null), i++;
            ...
            if (b = a.hooks.run(this.instance, "modifyRow", b), "string" == typeof c && c.indexOf(".") > -1) {
                var d = c.split("."), e = this.dataSource[b];
                if (!e)return null;
                for (var f = 0, g = d.length; g > f; f++)if (e = e[d[f]], "undefined" == typeof e)return null;
                return e
            }
        ...
        var b = function (b, c, d, e, f, g, h) {
            ...
            var i, j = h.hashLength || g.length, k = h.hashSymbol || "*";
        ...
        a.EditorState = {
            ...
            if (b) {
                var c, d = this.instance.getSelected();
                d[0] > d[2] && (c = d[0], d[0] = d[2], d[2] = c), d[1] > d[3] && (c = d[1], d[1] = d[3], d[3] = c), this.instance.populateFromArray(d[0], d[1], a, d[2], d[3], "edit")
            } else this.instance.populateFromArray(this.row, this.col, a, null, null, "edit")
        }, b.prototype.beginEditing = function (b) {
            this.state == a.EditorState.VIRGIN && (this.instance.view.scrollViewport(new l(this.row, this.col)), this.instance.view.render(), this.state = a.EditorState.EDITING, b = "string" == typeof b ? b : this.originalValue, this.setValue(a.helper.stringify(b)), this.open(), this._opened = !0, this.focus(), this.instance.view.render())
            ...
            if (!this.isWaiting()) {
                ...
                if (this.state == a.EditorState.EDITING) {
                    ...
                    e = this.instance.getSettings().trimWhitespace ? [[String.prototype.trim.call(this.getValue())]] : [[this.getValue()]], this.state = a.EditorState.WAITING, this.saveValue(e, c), this.instance.getCellValidator(this.cellProperties) ? this.instance.addHookOnce("postAfterValidate", function (b) {
        ...
        b.prototype.init = function () {
            var b = this;
            this.createElements(), this.eventManager = new a.eventManager(this), this.bindEvents(), this.autoResize = J(), this.instance.addHook("afterDestroy", function () {
                b.destroy()
            })
        }, b.prototype.getValue = function () {
        ...
        var c = function (b) {
            var c, d, e = this, f = e.getActiveEditor();
            if (c = a.helper.keyCode, d = (b.ctrlKey || b.metaKey) && !b.altKey, a.Dom.enableImmediatePropagation(b), b.target === f.TEXTAREA && !b.isImmediatePropagationStopped()) {
                ...
                switch (b.keyCode) {
                    ...
                    case c.ARROW_LEFT:
                        ...
                        break;
                    case c.ENTER:
                        var g = f.instance.getSelected(), h = !(g[0] === g[2] && g[1] === g[3]);
                        if (d && !h || b.altKey) {
                            if (f.isOpened()) {
                                var i = a.Dom.getCaretPosition(f.TEXTAREA), j = f.getValue(), k = j.slice(0, i) + "\n" + j.slice(i);
        ...
        b.prototype.open = function () {
            ...
            switch (b) {
                case"top":
                    a = this.instance.view.wt.wtScrollbars.vertical.clone.wtTable.getCell({
                        row: this.row,
                        col: this.col
                    }), this.textareaParentStyle.zIndex = 101;
                    break;
                case"corner":
                    a = this.instance.view.wt.wtScrollbars.corner.clone.wtTable.getCell({
                        row: this.row,
                        col: this.col
                    }), this.textareaParentStyle.zIndex = 103;
                    break;
                case"left":
                    a = this.instance.view.wt.wtScrollbars.horizontal.clone.wtTable.getCell({
                        row: this.row,
                        col: this.col
            ...
            if (this.state === a.EditorState.EDITING && (this.TD = this.getEditedCell(), this.TD)) {
                var b, c = a.Dom.offset(this.TD), d = a.Dom.offset(this.instance.rootElement), e = c.top - d.top - 1, f = c.left - d.left - 1, g = this.instance.getSettings(), h = g.rowHeaders === !1 ? 0 : 1, i = g.colHeaders === !1 ? 0 : 1, j = this.checkEditorSection();
                switch (j) {
                    case"top":
                        b = a.Dom.getCssTransform(this.instance.view.wt.wtScrollbars.vertical.clone.wtTable.holder.parentNode);
                        break;
                    case"left":
                        b = a.Dom.getCssTransform(this.instance.view.wt.wtScrollbars.horizontal.clone.wtTable.holder.parentNode);
                        break;
                    case"corner":
                        b = a.Dom.getCssTransform(this.instance.view.wt.wtScrollbars.corner.clone.wtTable.holder.parentNode)
                }
                0 > e && (e = 0), 0 > f && (f = 0), h > 0 && parseInt(this.TD.style.borderTopWidth, 10) > 0 && (e += 1), i > 0 && parseInt(this.TD.style.borderLeftWidth, 10) > 0 && (f += 1), h && 0 === this.instance.getSelected()[0] && (e += 1), b && -1 != b ? this.textareaParentStyle[b[0]] = b[1] : a.Dom.resetCssTransform(this.textareaParentStyle), this.textareaParentStyle.top = e + "px", this.textareaParentStyle.left = f + "px";
                var k = this.TD.offsetTop - this.instance.view.wt.wtScrollbars.vertical.getScrollPosition(), l = this.TD.offsetLeft - this.instance.view.wt.wtScrollbars.horizontal.getScrollPosition(), m = a.Dom.innerWidth(this.TD) - 8, n = this.instance.view.maximumVisibleElementWidth(l) - 10, o = a.Dom.outerHeight(this.TD) - 4, p = this.instance.view.maximumVisibleElementHeight(k) - 2;
                parseInt(this.TD.style.borderTopWidth, 10) > 0 && (o -= 1), parseInt(this.TD.style.borderLeftWidth, 10) > 0 && h > 0 && (m -= 1), this.TEXTAREA.style.fontSize = a.Dom.getComputedStyle(this.TD).fontSize, this.TEXTAREA.style.fontFamily = a.Dom.getComputedStyle(this.TD).fontFamily, this.autoResize.init(this.TEXTAREA, {
                    minHeight: Math.min(o, p),
                    maxHeight: p,
                    minWidth: Math.min(m, n),
                    maxWidth: n
        ...
        var c = b.editors.BaseEditor.prototype.extend(), d = {}, e = function () {
        ...
        c.prototype.valueChanged = function () {
            ...
            var c = this, d = c.getActiveEditor();
            ...
            if (c && e)c = parseInt(c, 10), e = parseInt(e, 10), this.editorContainer.style.top = e + "px", this.editorContainer.style.left = c + "px"; else {
                var f = this.instance.getSelected(), g = this.instance.getCell(f[0], f[1]);
                if (d.cellPointer || (d.cellPointer = {
                        height: b.Dom.outerHeight(this.cellPointer),
                        width: b.Dom.outerWidth(this.cellPointer)
                    }), d.editorContainer || (d.editorContainer = {width: b.Dom.outerWidth(this.editorContainer)}), void 0 !== g) {
                    var h = this.instance.view.wt.wtScrollbars.horizontal.scrollHandler == a ? 0 : b.Dom.getScrollLeft(this.instance.view.wt.wtScrollbars.horizontal.scrollHandler), i = this.instance.view.wt.wtScrollbars.vertical.scrollHandler == a ? 0 : b.Dom.getScrollTop(this.instance.view.wt.wtScrollbars.vertical.scrollHandler), j = b.Dom.offset(g), k = b.Dom.outerWidth(g), l = {
                        x: h,
                        y: i
                    };
            ...
            var a;
            return this.valueChanged() ? (a = this.instance.getSettings().trimWhitespace ? [[String.prototype.trim.call(this.getValue())]] : [[this.getValue()]], void this.saveValue(a)) : !0
            ...
            }), this.eventManager.addEventListener(this.instance.view.wt.wtScrollbars.horizontal.scrollHandler, "scroll", function () {
                c.instance.view.wt.wtScrollbars.horizontal.scrollHandler != a && c.hideCellPointer()
            }), this.eventManager.addEventListener(this.instance.view.wt.wtScrollbars.vertical.scrollHandler, "scroll", function () {
                c.instance.view.wt.wtScrollbars.vertical.scrollHandler != a && c.hideCellPointer()
            })
        ...
        }, a.editors.CheckboxEditor = b, a.editors.registerEditor("checkbox", b)
    }(b), function (b) {
        ...
        c.prototype.init = function () {
            ...
            b.editors.TextEditor.prototype.createElements.apply(this, arguments), this.defaultDatepickerTrigger = document.querySelector(".handsontableInput"), this.defaultDateFormat = "MM/DD/YYYY", this.datePicker = document.createElement("DIV"), b.Dom.addClass(this.datePicker, "htDatepickerHolder"), this.datePickerStyle = this.datePicker.style, this.datePickerStyle.position = "absolute", this.datePickerStyle.top = 0, this.datePickerStyle.left = 0, this.datePickerStyle.zIndex = 99, document.body.appendChild(this.datePicker);
            var a = this, c = {
                ...
                reposition: !1,
                onSelect: function (b) {
                    isNaN(b.getTime()) || (b = moment(b).format(a.cellProperties.dateFormat || a.defaultDateFormat)), a.setValue(b)
                },
                onClose: function () {
                    a.parentDestroyed || a.finishEditing(!1)
                }
            };
            this.$datePicker = new Pikaday(c);
            var d = b.eventManager(this);
            d.addEventListener(this.datePicker, "mousedown", function (a) {
            ...
            b.editors.TextEditor.prototype.open.call(this), this.showDatepicker()
        }, c.prototype.close = function () {
            this._opened = !1, b.editors.TextEditor.prototype.close.apply(this, arguments)
        }, c.prototype.finishEditing = function () {
            this.hideDatepicker(), b.editors.TextEditor.prototype.finishEditing.apply(this, arguments)
        }, c.prototype.showDatepicker = function () {
            var c = this.TD.getBoundingClientRect(), d = this;
            this.datePickerStyle.top = a.pageYOffset + c.top + b.Dom.outerHeight(this.TD) + "px", this.datePickerStyle.left = a.pageXOffset + c.left + "px", this.originalValue && (this.$datePicker.setDate(this.originalValue, !0), this.setValue(this.originalValue)), this.$datePicker.config().trigger = document.querySelector(".htAutocomplete.current"), this.datePickerStyle.display = "block", this.$datePicker.show(), this.instance._registerTimeout(setTimeout(function () {
                d.$datePicker.config().trigger = d.defaultDatepickerTrigger
            }, 50))
        ...
        var c = function (b) {
            if (null != b && null == b.isImmediatePropagationEnabled && (b.stopImmediatePropagation = function () {
                ...
                var c, d = this.getActiveEditor(), e = d.htEditor.getInstance();
                if (b.keyCode == a.helper.keyCode.ARROW_DOWN)if (e.getSelected()) {
                    var f = e.getSelected()[0], g = e.countRows() - 1;
                    c = Math.min(g, f + 1)
                } else c = 0; else if (b.keyCode == a.helper.keyCode.ARROW_UP && e.getSelected()) {
        ...
        c.prototype.init = function () {
            b.editors.HandsontableEditor.prototype.init.apply(this, arguments);
            var a = this.htEditor.getInstance();
            a.updateSettings({height: 1}), this.query = null, this.choices = []
        }, c.prototype.createElements = function () {
        ...
        var d = !1, e = function (a) {
            d = !1;
            var c = this.getActiveEditor(), e = b.helper.keyCode;
        ...
        c.prototype.prepare = function () {
            ...
            b.editors.HandsontableEditor.prototype.open.apply(this, arguments), this.TEXTAREA.style.visibility = "visible", this.focus(), this.htContainer.style.overflow = "hidden";
            var a = this.htEditor.getInstance(), c = this;
            a.updateSettings({
                colWidths: [b.Dom.outerWidth(this.TEXTAREA) - 2],
                afterRenderer: function (a, b, d, e, f) {
                    var g = this.getCellMeta(b, d).filteringCaseSensitive === !0;
                    if (f) {
                        var h = g ? f.indexOf(this.query) : f.toLowerCase().indexOf(c.query.toLowerCase());
                        if (-1 != h) {
                            var i = f.substr(h, c.query.length);
                            a.innerHTML = f.replace(i, "<strong>" + i + "</strong>")
                        }
                    }
                }
            }), d && (d = !1), c.instance._registerTimeout(setTimeout(function () {
                c.queryChoices(c.TEXTAREA.value), c.htContainer.style.overflow = "auto"
            }, 0))
        }, c.prototype.close = function () {
            ...
            var d, e = b.Dom.getCaretPosition(this.TEXTAREA), f = b.Dom.getSelectionEndPosition(this.TEXTAREA), g = c.sortByRelevance(this.getValue(), a, this.cellProperties.filteringCaseSensitive);
            if (0 != this.cellProperties.filter) {
                for (var h = [], i = 0, j = g.length; j > i; i++)h.push(a[g[i]]);
                d = 0, a = h
            } else d = g[0];
            this.choices = a, this.htEditor.loadData(b.helper.pivot([a])), this.htEditor.updateSettings({height: this.getDropdownHeight()}), this.cellProperties.strict === !0 && this.highlightBestMatchingChoice(d), this.instance.listen(), this.TEXTAREA.focus(), b.Dom.setCaretPosition(this.TEXTAREA, e, e != f ? f : void 0)
        ...
        var c = function (b) {
            ...
            switch (b.keyCode) {
                case a.helper.keyCode.ARROW_UP:
                    var e = d.select.find("option:selected").prev();
                    1 == e.length && e.prop("selected", !0), b.stopImmediatePropagation(), b.preventDefault();
                    break;
                case a.helper.keyCode.ARROW_DOWN:
                    var f = d.select.find("option:selected").next();
                    1 == f.length && f.prop("selected", !0), b.stopImmediatePropagation(), b.preventDefault()
            }
        };
        b.prototype.checkEditorSection = function () {
            return this.row < this.instance.getSettings().fixedRowsTop ? this.col < this.instance.getSettings().fixedColumnsLeft ? "corner" : "top" : this.col < this.instance.getSettings().fixedColumnsLeft ? "left" : void 0
        }, b.prototype.open = function () {
            var b, d = a.Dom.outerWidth(this.TD), e = a.Dom.outerHeight(this.TD), f = a.Dom.offset(this.instance.rootElement), g = a.Dom.offset(this.TD), h = this.checkEditorSection();
            switch (h) {
                case"top":
                    b = a.Dom.getCssTransform(this.instance.view.wt.wtScrollbars.vertical.clone.wtTable.holder.parentNode);
                    break;
        ...
        var d = null, e = !0, f = b.editors.getEditor("date", this.instance);
        null === a && (a = "");
        var g = moment(new Date(a)).isValid(), h = moment(a, this.dateFormat || f.defaultDateFormat, !0).isValid();
        g || (e = !1), !g && h && (e = !0), g && !h && (this.correctFormat === !0 ? (d = H(a, this.dateFormat), this.instance.setDataAtCell(this.row, this.col, d, "dateValidator"), e = !0) : e = !1), c(e)
    };
    var H = function (a, b) {
    ...
    b.AutocompleteValidator = function (a, b) {
        this.strict && this.source ? "function" == typeof this.source ? this.source(a, I(a, b)) : I(a, b)(this.source) : b(!0)
    ...
    }, b.cellLookup = {validator: {numeric: b.NumericValidator, autocomplete: b.AutocompleteValidator}};
    var J = function () {
        var c, d = {
            minHeight: 200,
            maxHeight: 300,
            minWidth: 100,
            maxWidth: 300
        }, e = document.body, f = document.createTextNode(""), g = document.createElement("SPAN"), h = function (b, c, d) {
            ...
            if (a && a.minHeight)if ("inherit" == a.minHeight)d.minHeight = c.clientHeight; else {
                var b = parseInt(a.minHeight);
                isNaN(b) || (d.minHeight = b)
            }
            if (a && a.maxHeight)if ("inherit" == a.maxHeight)d.maxHeight = c.clientHeight; else {
                var e = parseInt(a.maxHeight);
                isNaN(e) || (d.maxHeight = e)
            }
            if (a && a.minWidth)if ("inherit" == a.minWidth)d.minWidth = c.clientWidth; else {
                var h = parseInt(a.minWidth);
                isNaN(h) || (d.minWidth = h)
            }
            if (a && a.maxWidth)if ("inherit" == a.maxWidth)d.maxWidth = c.clientWidth; else {
    ...
    c.prototype.init = function () {
        ...
        var b = this, c = !1;
        if (a.metaKey ? c = !0 : a.ctrlKey && -1 === navigator.userAgent.indexOf("Mac") && (c = !0), c) {
            if (document.activeElement !== this.elTextarea && ("" !== this.getSelectionText() || -1 !== ["INPUT", "SELECT", "TEXTAREA"].indexOf(document.activeElement.nodeName)))return;
            this.selectNodeText(this.elTextarea), setTimeout(function () {
                b.selectNodeText(b.elTextarea)
            }, 0)
        }
        !c || 67 !== a.keyCode && 86 !== a.keyCode && 88 !== a.keyCode || (88 === a.keyCode ? setTimeout(function () {
            b.triggerCut(a)
        ...
        var b, c;
        for (b = 0, c = this.copyCallbacks.length; c > b; b++)if (this.copyCallbacks[b] === a)return this.copyCallbacks.splice(b, 1), !0;
        for (b = 0, c = this.cutCallbacks.length; c > b; b++)if (this.cutCallbacks[b] === a)return this.cutCallbacks.splice(b, 1), !0;
        for (b = 0, c = this.pasteCallbacks.length; c > b; b++)if (this.pasteCallbacks[b] === a)return this.pasteCallbacks.splice(b, 1), !0;
        return !1
    ...
    !function (b) {
        ...
        function h(a, b) {
            for (var c = 0, d = a.observers.length; d > c; c++)if (a.observers[c].observer === b)return void a.observers.splice(c, 1)
        }
        ...
        function j(b, c) {
            ...
            if (Object.observe)d = function (a) {
                ...
                var n = this.intervals || [100, 1e3, 1e4, 6e4], o = 0, p = function () {
                    m(d)
                }, q = function () {
        ...
        function n(a, b, d, e) {
            for (var f = v(b), g = v(a), h = !1, i = !1, j = g.length - 1; j >= 0; j--) {
                ...
                } else d.push({op: "remove", path: e + "/" + c(k)}), delete a[k], i = !0
            }
        ...
        var p = {
            add: function (a, b) {
                ...
                return o(c, [d]), o(c, [{op: "remove", path: this.from}]), o(c, [{
                    op: "add",
                    path: this.path,
                    value: d.value
                }]), !0
                ...
                var d = {op: "_get", path: this.from};
                return o(c, [d]), o(c, [{op: "add", path: this.path, value: d.value}]), !0
            }, test: function (a, b) {
            ...
            add: function (a, b) {
                ...
                return a[b] = this.value, !0
            }, move: p.move, copy: p.copy, test: p.test, _get: p._get
        }, r = {
            add: function (a, b) {
                var d = {op: "add", path: b + c(this.name), value: this.object[this.name]};
                a.push(d)
            }, "delete": function (a, b) {
                var d = {op: "remove", path: b + c(this.name)};
                a.push(d)
            }, update: function (a, b) {
                var d = {op: "replace", path: b + c(this.name), value: this.object[this.name]};
                a.push(d)
            }
        }, s = [];
        b.intervals;
    ...
    }(L || (L = {})), "undefined" != typeof exports && (exports.apply = L.apply, exports.observe = L.observe, exports.unobserve = L.unobserve, exports.generate = L.generate), b.PluginHookClass = function () {
        function a() {
        ...
        return a.prototype.getBucket = function (a) {
            ...
            if (Array.isArray(b))for (var e = 0, f = b.length; f > e; e++)this.add(a, b[e]); else {
                a in c && (a = c[a]);
            ...
            if (Array.isArray(b))for (var d = 0, e = b.length; e > d; d++)b[d].runOnce = !0, this.add(a, b[d], c); else b.runOnce = !0, this.add(a, b, c)
        }, a.prototype.remove = function (a, b, d) {
            var e = !1;
            a in c && (a = c[a]);
            var f = this.getBucket(d);
            if ("undefined" != typeof f[a])for (var g = 0, h = f[a].length; h > g; g++)if (f[a][g] == b) {
                f[a][g].skip = !0, e = !0;
                break
            }
            return e
            ...
            for (var c in b)if (b.hasOwnProperty(c))for (var d = 0, e = b[c].length; e > d; d++)this.remove(c, b[c], a)
            ...
            var j, k, l, m = a[c];
            if (m)for (k = 0, l = m.length; l > k; k++)m[k].skip || (j = m[k].call(b, d, e, f, g, h, i), void 0 !== j && (d = j), m[k].runOnce && this.remove(c, m[k], a === this.globalBucket ? null : b));
            return d
    ...
    }(), b.hooks = new b.PluginHookClass, b.PluginHooks = b.hooks, function (a) {
        function b() {
            function b(a) {
                var b = document, c = this;
            ...
            this.beforeInit = function () {
                ...
                var d = this, f = d.autoColumnSizeTmp;
                ...
                for (var g = d.countRows(), h = {}, i = 0, j = 0; g > j; j++) {
                    var k = a.helper.stringify(d.getDataAtCell(j, c)), l = k.length;
                    l > i && (i = l), h[l] || (h[l] = {
                        needed: e,
                        strings: []
                    }), h[l].needed && (h[l].strings.push({value: k, row: j}), h[l].needed--)
                }
                var m = d.getSettings();
                m.colHeaders && d.view.appendColHeader(c, f.theadTh), a.Dom.empty(f.tbody);
                for (var n in h)if (h.hasOwnProperty(n))for (var o = 0, p = h[n].strings.length; p > o; o++) {
                    var q = h[n].strings[o].row, r = d.getCellMeta(q, c);
                    r.col = c, r.row = q;
                    var s = d.getCellRenderer(r), t = document.createElement("tr"), u = document.createElement("td");
                ...
                var a = this, b = this.getSettings();
                if (b.autoColumnSize || !b.colWidths)for (var c = this.countCols(), e = 0; c > e; e++)a._getColWidthFromSettings(e) || (this.autoColumnWidths[e] = d.determineColumnWidth.call(a, e))
    ...
    b.hooks.add("afterInit", function () {
        M.init.call(this, "afterInit")
    }), b.hooks.add("afterUpdateSettings", function () {
        M.init.call(this, "afterUpdateSettings")
    }), b.hooks.add("modifyRow", M.translateRow), b.hooks.add("afterGetColHeader", M.getColHeader), b.hooks.register("beforeColumnSort"), b.hooks.register("afterColumnSort"), function (a) {
        function b(a, b) {
        ...
        function d(a) {
            for (var b = {}, c = a.from.row; c <= a.to.row; c++)for (var d = a.from.col; d <= a.to.col; d++)b[c] || (b[c] = []), b[c][d] = this.getCellMeta(c, d).className;
            return b
        }

        function e(a, d, e, f) {
            var g = this.getCellMeta(a, d), h = f;
            g.className && (h = "vertical" === e ? b(g.className, f) : c(g.className, f)), this.setCellMeta(a, d, "className", h)
        }

        function f(a, b, c) {
            var f = d.call(this, a);
            if (this.runHooks("beforeCellAlignment", f, a, b, c), a.from.row == a.to.row && a.from.col == a.to.col)e.call(this, a.from.row, a.from.col, b, c); else for (var g = a.from.row; g <= a.to.row; g++)for (var h = a.from.col; h <= a.to.col; h++)e.call(this, g, h, b, c);
            this.render()
        }
        ...
        function g(b) {
            ...
            if (c.menus = [], c.htMenus = {}, c.triggerRows = [], c.eventManager = a.eventManager(c), this.enabled = !0, this.instance.addHook("afterDestroy", function () {
                    ...
                    items: [{
                        ...
                        disabled: function () {
                            var a = this.getSelected(), b = [0, a[1], this.countRows() - 1, a[1]], c = b.join(",") == a.join(",");
                            return a[0] < 0 || this.countRows() >= this.getSettings().maxRows || c
                        }
                    }, {
                        key: "row_below", name: "Insert row below", callback: function (a, b) {
                        ...
                        key: "col_left", name: "Insert column on the left", callback: function (a, b) {
                            this.alter("insert_col", b.start.col)
                        }, disabled: function () {
                            var a = this.getSelected(), b = [a[0], 0, a[0], this.countCols() - 1], c = b.join(",") == a.join(",");
                            return this.getSelected()[1] < 0 || this.countCols() >= this.getSettings().maxCols || c
                        }
                    }, {
                        key: "col_right", name: "Insert column on the right", callback: function (a, b) {
                        ...
                        key: "remove_row", name: "Remove row", callback: function (a, b) {
                        ...
                        key: "remove_col", name: "Remove column", callback: function (a, b) {
                        ...
                        key: "make_read_only", name: function () {
                            var a = "Read only", b = c.checkSelectionReadOnlyConsistency(this);
                            return b && (a = c.markSelected(a)), a
                        }, callback: function () {
                            var a = c.checkSelectionReadOnlyConsistency(this), b = this;
                        ...
                        key: "alignment", name: "Alignment", submenu: {
                            items: [{
                                name: function () {
                                    var a = "Left", b = c.checkSelectionAlignment(this, "htLeft");
                                    return b && (a = c.markSelected(a)), a
                                }, callback: function () {
                                ...
                                name: function () {
                                    var a = "Center", b = c.checkSelectionAlignment(this, "htCenter");
                                    return b && (a = c.markSelected(a)), a
                                }, callback: function () {
                                ...
                                name: function () {
                                    var a = "Right", b = c.checkSelectionAlignment(this, "htRight");
                                    return b && (a = c.markSelected(a)), a
                                }, callback: function () {
                                ...
                                name: function () {
                                    var a = "Justify", b = c.checkSelectionAlignment(this, "htJustify");
                                    return b && (a = c.markSelected(a)), a
                                }, callback: function () {
                                ...
                                name: function () {
                                    var a = "Top", b = c.checkSelectionAlignment(this, "htTop");
                                    return b && (a = c.markSelected(a)), a
                                }, callback: function () {
                                ...
                                name: function () {
                                    var a = "Middle", b = c.checkSelectionAlignment(this, "htMiddle");
                                    return b && (a = c.markSelected(a)), a
                                }, callback: function () {
                                ...
                                name: function () {
                                    var a = "Bottom", b = c.checkSelectionAlignment(this, "htBottom");
                                    return b && (a = c.markSelected(a)), a
                                }, callback: function () {
        ...
        function h(a, b) {
            for (var c = 0, d = a.length; d > c; c++)if (a[c].key === b)return a[c]
        }

        function i(a, b) {
            for (var c = 0, d = a.length; d > c; c++)if (a[c].key === b)return c
        }

        function j() {
            if (!this.rootElement.className.indexOf("htContextMenu")) {
                for (var a = 0, b = 0, c = this.getSettings().data.length, d = 0; c > d; d++)this.getSettings().data[d].name == g.SEPARATOR.name ? a += 2 : b += 26;
                this.view.wt.wtScrollbars.vertical.fixedContainer.style.height = b + a + "px"
            }
        }

        function k() {
            var b = this, c = b.getSettings().contextMenu, d = a.helper.isObject(c) ? c : {};
        ...
        g.prototype.createMenu = function (b, c) {
            ...
            function b(b) {
                var c = this.instance.getSettings();
                this.closeAll(), b.preventDefault(), a.helper.stopPropagation(b);
                var d = this.instance.getSettings().rowHeaders, e = this.instance.getSettings().colHeaders;
                if (d || e) {
                    if (d && e) {
                        var f = b.target.parentNode.querySelectorAll(".cornerHeader").length > 0;
                        if (f)return
                    }
                } else if (!("TD" == b.target.nodeName || a.Dom.hasClass(b.target, "current") && a.Dom.hasClass(b.target, "wtBorder")))return;
                var h = this.createMenu(), i = this.getItems(c.contextMenu);
                this.show(h, i), this.setMenuPosition(b, h), this.eventManager.addEventListener(document.documentElement, "mousedown", a.helper.proxy(g.prototype.closeAll, this))
            }
            ...
            var c = this, d = b.getSelected()[0], e = b.getData()[d];
            if (e.disabled !== !0 && ("function" != typeof e.disabled || e.disabled.call(this.instance) !== !0) && !e.hasOwnProperty("submenu")) {
                ...
                var f = this.instance.getSelectedRange(), h = g.utils.normalizeSelection(f);
            ...
            var e = {
                ...
                readOnly: !0,
                copyPaste: !1,
                columns: [{data: "name", renderer: a.helper.proxy(this.renderer, this)}],
                renderAllRows: !0,
            ...
            this.eventManager.removeEventListener(b, "mousedown"), this.eventManager.addEventListener(b, "mousedown", function (a) {
                d.performAction(a, f)
            ...
            var l = this, m = b.getData()[d], n = document.createElement("DIV");
            ...
            if (-1 != c.className.indexOf("htSubmenu")) {
                var g = d.getData()[b.row], h = this.getItems(g.submenu), i = this.createMenu(g.name, b.row), j = c.getBoundingClientRect();
                ...
                case a.helper.keyCode.ARROW_LEFT:
                    if (k) {
                        if (-1 != c.rootElement.className.indexOf("htContextSubMenu_")) {
                            ...
                            if (n > 0) {
                                var o = j.menus[n - 1], p = j.triggerRows.pop();
            ...
            var d = a.Dom.getWindowScrollTop(), e = a.Dom.getWindowScrollLeft(), f = {
                top: d + b.top,
                topRelative: b.top,
                left: b.left,
            ...
            var d = a.Dom.getWindowScrollTop(), e = a.Dom.getWindowScrollLeft(), f = b.pageY || b.clientY + d, g = b.pageX || b.clientX + e, h = {
                top: f,
                topRelative: f - d,
                left: g,
                leftRelative: g - e,
            ...
            return {start: a.getTopLeftCorner(), end: a.getBottomRightCorner()}
            ...
            f.call(this, a, b, c)
        }, g.SEPARATOR = {name: "---------"}, a.hooks.add("afterInit", k), a.hooks.add("afterUpdateSettings", k), a.hooks.add("afterInit", j), a.PluginHooks.register("afterContextMenuDefaultOptions"), a.ContextMenu = g
    }(b);
    var N = function () {
        var a = this, c = a.getSettings().comments;
        c && (b.Comments = new e(a), b.Comments.init())
    }, O = function (a, c, d, e, f, g) {
    ...
    b.hooks.add("beforeInit", N), b.hooks.add("afterContextMenuDefaultOptions", P), b.hooks.add("afterRenderer", O), function (b) {
        function c() {
            function c(a) {
                m = this, n = a;
            ...
            var h, i, j, k, l, m, n, o = document.createElement("DIV"), p = document.createElement("DIV"), q = b.eventManager(this);
            ...
            this.beforeInit = function () {
                ...
                if (c) {
                    var d = this.getSettings().manualColumnMove, e = s.call(b);
        ...
        function c() {
            ...
            var h, i, j, k, l, m, n, o, p = document.createElement("DIV"), q = document.createElement("DIV"), r = b.eventManager(this);
            ...
            this.beforeInit = function () {
                ...
                var b = this, c = !!this.getSettings().manualColumnResize;
                if (c) {
                    var d = this.getSettings().manualColumnResize, e = t.call(b);
        ...
        function c() {
            ...
            this.beforeInit = function () {
                ...
                var b = this, c = !!this.getSettings().manualRowResize;
                if (c) {
                    var d = this.getSettings().manualRowResize, e = t.call(b);
        ...
        function c() {
            ...
            }, a.observedData = a.getData(), a.observer = L.observe(a.observedData, function (b) {
        ...
        function d(a) {
            ...
            function e(a) {
                var b = a.match(/^\/(\d+)\/?(.*)?$/);
                return {row: parseInt(b[1], 10), col: /^\d*$/.test(b[2]) ? parseInt(b[2], 10) : b[2]}
            }
        ...
        function f() {
            var a = this;
            L.unobserve(a.observedData, a.observer), delete a.observeChangesActive, delete a.pauseObservingChanges, delete a.resumeObservingChanges
        }
        ...
        function c() {
            ...
            var e = this;
            this.init = function () {
                var b = this, f = b.getSettings().persistentState;
        ...
        a.UndoRedo = function (b) {
            ...
            this.instance = b, this.doneActions = [], this.undoneActions = [], this.ignoreNewActions = !1, b.addHook("afterChange", function (b) {
                ...
                var f = e.slice(b, b + d), g = new a.UndoRedo.RemoveRowAction(b, f);
                c.done(g)
        ...
        }, a.UndoRedo.Action = function () {
        }, a.UndoRedo.Action.prototype.undo = function () {
        }, a.UndoRedo.Action.prototype.redo = function () {
        }, a.UndoRedo.ChangeAction = function (a) {
            this.changes = a
            ...
            if (a.contextMenu) {
                for (var c = this.range.from.row; c <= this.range.to.row; c++)for (var d = this.range.from.col; d <= this.range.to.col; d++)a.contextMenu.align.call(a, this.range, this.type, this.alignment);
                a.addHookOnce("afterRender", b), a.render()
            }
        ...
        function b() {
            var b = this, g = "undefined" == typeof b.getSettings().undo || b.getSettings().undo;
    ...
    if (function (a, b, c) {
            function d(d) {
                ...
                this.copyPasteInstance = b.getInstance(), this.copyPasteInstance.onCut(e), this.copyPasteInstance.onPaste(f), d.addHook("beforeKeyDown", g), this.destroy = function () {
                    ...
                    var b = d.getSettings(), c = b.copyRowsLimit, e = b.copyColsLimit, f = d.getSelectedRange(), g = f.getTopLeftCorner(), h = f.getBottomRightCorner(), i = g.row, j = g.col, k = h.row, l = h.col, m = Math.min(k, i + c - 1), n = Math.min(l, j + e - 1);
        ...
        }(b, K, SheetClip), function (a) {
            function b() {
                var b = this, c = !!b.getSettings().search;
                c ? b.search = new a.Search(b) : delete b.search
            }

            a.Search = function (b) {
                this.query = function (c, d, e) {
                    var f = b.countRows(), g = b.countCols(), h = [];
                    d || (d = a.Search.global.getDefaultCallback()), e || (e = a.Search.global.getDefaultQueryMethod());
                    for (var i = 0; f > i; i++)for (var j = 0; g > j; j++) {
                        var k = b.getDataAtCell(i, j), l = b.getCellMeta(i, j), m = l.search.callback || d, n = l.search.queryMethod || e, o = n(c, k);
                        if (o) {
                            var p = {row: i, col: j, data: k};
                            h.push(p)
                        }
                        m && m(b, i, j, k, o)
                    }
                ...
                var b = a.Search.DEFAULT_CALLBACK, c = a.Search.DEFAULT_QUERY_METHOD, d = a.Search.DEFAULT_SEARCH_RESULT_CLASS;
                return {
            ...
            if ("modifyTransformStart" == a) {
                ...
                if (j) {
                    var p = new l(j.row, j.col), q = new l(j.row + j.rowspan - 1, j.col + j.colspan - 1), r = new m(p, p, q);
                ...
                var s = new l(b.highlight.row + g.row, b.highlight.col + g.col), t = this.mergedCellInfoCollection.getInfo(s.row, s.col);
                t && (this.lastDesiredCoords = s, g = {row: t.row - i.row, col: t.col - i.col})
            } else if ("modifyTransformEnd" == a)for (var k = 0, n = this.mergedCellInfoCollection.length; n > k; k++) {
                var u = this.mergedCellInfoCollection[k], p = new l(u.row, u.col), q = new l(u.row + u.rowspan - 1, u.col + u.colspan - 1), v = new m(p, p, q), w = b.getBordersSharedWith(v);
    ...
    var T = function () {
        ...
        a.mergeCells && (a.view.wt.wtTable.getCell = function (b) {
            ...
            return B.prototype.getCell.call(this, b)
        })
    }, V = function (a) {
        if (this.mergeCells) {
        ...
        if (b) {
            ...
            do {
                ...
                for (var e = 0, f = this.mergeCells.mergedCellInfoCollection.length; f > e; e++) {
                    var g = this.mergeCells.mergedCellInfoCollection[e], h = new l(g.row, g.col), i = new l(g.row + g.rowspan - 1, g.col + g.colspan - 1), j = new m(h, h, i);
        ...
        if (b && "area" == b) {
            var c = this.getSettings().mergeCells;
            if (c)for (var d = this.getSelectedRange(), e = new m(d.from, d.from, d.from), f = new m(d.to, d.to, d.to), g = 0, h = this.mergeCells.mergedCellInfoCollection.length; h > g; g++) {
                var i = this.mergeCells.mergedCellInfoCollection[g], j = new l(i.row, i.col), k = new l(i.row + i.rowspan - 1, i.col + i.colspan - 1), n = new m(j, j, k);
        ...
        if (b)for (var c, d = this.countCols(), e = 0; d > e; e++) {
            if (c = this.mergeCells.mergedCellInfoCollection.getInfo(a.startRow, e), c && c.row < a.startRow)return a.startRow = c.row, _.call(this, a);
            if (c = this.mergeCells.mergedCellInfoCollection.getInfo(a.endRow, e)) {
                var f = c.row + c.rowspan - 1;
                if (f > a.endRow)return a.endRow = f, _.call(this, a)
            }
        }
    }, ab = function (a) {
        var b = this.getSettings().mergeCells;
        if (b)for (var c, d = this.countRows(), e = 0; d > e; e++) {
            if (c = this.mergeCells.mergedCellInfoCollection.getInfo(e, a.startColumn), c && c.col < a.startColumn)return a.startColumn = c.col, ab.call(this, a);
            if (c = this.mergeCells.mergedCellInfoCollection.getInfo(e, a.endColumn)) {
                var f = c.col + c.colspan - 1;
                if (f > a.endColumn)return a.endColumn = f, ab.call(this, a)
            }
        }
    }, bb = function (a) {
    ...
    b.hooks.add("beforeInit", T), b.hooks.add("afterInit", U), b.hooks.add("beforeKeyDown", V), b.hooks.add("modifyTransformStart", X("modifyTransformStart")), b.hooks.add("modifyTransformEnd", X("modifyTransformEnd")), b.hooks.add("beforeSetRangeEnd", Y), b.hooks.add("beforeDrawBorders", Z), b.hooks.add("afterIsMultipleSelection", bb), b.hooks.add("afterRenderer", O), b.hooks.add("afterContextMenuDefaultOptions", W), b.hooks.add("afterGetCellMeta", $), b.hooks.add("afterViewportRowCalculatorOverride", _), b.hooks.add("afterViewportColumnCalculatorOverride", ab), b.MergeCells = i, function () {
        function a() {
        }
        ...
        var c, d = function (a) {
            ...
            for (var b = 0; b < c.view.wt.selections.length; b++)if (c.view.wt.selections[b].settings.className == a)return b;
            return -1
        }, g = function (a) {
            var b = {row: a.row, col: a.col}, d = new z(a, new m(b, b, b)), e = f(a.className);
            ...
            return {className: j(a, b), border: n(), row: a, col: b, top: l(), right: l(), bottom: l(), left: l()}
        }, p = function (a, b) {
            ...
            if (a.from.row == a.to.row && a.from.col == a.to.col)"noBorders" == b ? r.call(this, a.from.row, a.from.col) : s.call(this, a.from.row, a.from.col, b, c); else switch (b) {
                case"noBorders":
                    for (var d = a.from.col; d <= a.to.col; d++)for (var e = a.from.row; e <= a.to.row; e++)r.call(this, e, d);
                    break;
                case"top":
        ...
        function c() {
            function c(a) {
                ...
                if (b >= 0) {
                    ...
                    k = c.top, n.style.top = k + "px", n.style.left = c.left + "px", R.rootElement.appendChild(n)
                }
            }
            ...
            var h, i, j, k, l, m, n = document.createElement("DIV"), o = document.createElement("DIV"), p = b.eventManager(this);
            ...
            this.beforeInit = function () {
                ...
                if (c) {
                    var d = b.getSettings().manualRowMove, e = r.call(b);
        ...
        function c(c) {
            this.instance = c, this.addingStarted = !1;
            var d, e, f = !1, g = this, h = b.eventManager(c), i = function () {
                return c.autofill ? void(c.autofill.handle && c.autofill.handle.isDragged && (c.autofill.handle.isDragged > 1 && c.autofill.apply(), c.autofill.handle.isDragged = 0, f = !1)) : !0
            };
            h.addEventListener(document, "mouseup", function (a) {
                i(a)
            }), h.addEventListener(document, "mousemove", function (c) {
                if (!g.instance.autofill)return 0;
                var d = b.Dom.offset(g.instance.table).top - (a.pageYOffset || document.documentElement.scrollTop) + b.Dom.outerHeight(g.instance.table), e = b.Dom.offset(g.instance.table).left - (a.pageXOffset || document.documentElement.scrollLeft) + b.Dom.outerWidth(g.instance.table);
                g.addingStarted === !1 && g.instance.autofill.handle.isDragged > 0 && c.clientY > d && c.clientX <= e ? (this.mouseDragOutside = !0, g.addingStarted = !0) : this.mouseDragOutside = !1, this.mouseDragOutside && setTimeout(function () {
                    g.addingStarted = !1, g.instance.alter("insert_row")
                }, 200)
            }), d = this.instance.view.wt.wtSettings.settings.onCellCornerMouseDown, this.instance.view.wt.wtSettings.settings.onCellCornerMouseDown = function (a) {
                c.autofill.handle.isDragged = 1, f = !0, d(a)
            }, e = this.instance.view.wt.wtSettings.settings.onCellMouseOver, this.instance.view.wt.wtSettings.settings.onCellMouseOver = function (a, b, d, g) {
                c.autofill && f && !c.view.isMouseDown() && c.autofill.handle && c.autofill.handle.isDragged && (c.autofill.handle.isDragged++, c.autofill.showBorder(b), c.autofill.checkIfNewRowNeeded()), e(a, b, d, g)
        ...
        c.prototype.init = function () {
        ...
        }, c.prototype.selectAdjacent = function () {
            var a, b, c, d, e;
            ...
            var a, c, d, e, f;
            if (this.handle.isDragged = 0, a = this.instance.view.wt.selections.fill.getCorners()) {
                var g = function (a, b, c, d) {
                    var e, f, g, h = c.length, i = c ? c[0].length : 0, j = [], k = b.row - a.row, l = b.col - a.col, m = [];
                    if (-1 !== ["down", "up"].indexOf(d)) {
                        for (var n = 0; l >= n; n++)e = parseInt(c[0][n], 10), f = parseInt(c[h - 1][n], 10), g = ("down" === d ? f - e : e - f) / (h - 1) || 0, m.push(g);
                        j.push(m)
                    }
                    if (-1 !== ["right", "left"].indexOf(d))for (var o = 0; k >= o; o++)e = parseInt(c[o][0], 10), f = parseInt(c[o][i - 1], 10), g = ("right" === d ? f - e : e - f) / (i - 1) || 0, m = [], m.push(g), j.push(m);
                    return j
                };
                this.instance.view.wt.selections.fill.clear(), c = this.instance.selection.isMultiple() ? this.instance.view.wt.selections.area.getCorners() : this.instance.view.wt.selections.current.getCorners();
                var h;
                if (a[0] === c[0] && a[1] < c[1] ? (h = "left", d = new l(a[0], a[1]), e = new l(a[2], c[1] - 1)) : a[0] === c[0] && a[3] > c[3] ? (h = "right", d = new l(a[0], c[3] + 1), e = new l(a[2], a[3])) : a[0] < c[0] && a[1] === c[1] ? (h = "up", d = new l(a[0], a[1]), e = new l(c[0] - 1, a[3])) : a[2] > c[2] && a[1] === c[1] && (h = "down", d = new l(c[2] + 1, a[1]), e = new l(a[2], a[3])), d && d.row > -1 && d.col > -1) {
                    var i = {from: this.instance.getSelectedRange().from, to: this.instance.getSelectedRange().to};
                    f = this.instance.getData(i.from.row, i.from.col, i.to.row, i.to.col);
                    var j = g(d, e, f, h);
                    b.hooks.run(this.instance, "beforeAutofill", d, e, f), this.instance.populateFromArray(d.row, d.col, f, e.row, e.col, "autofill", null, h, j), this.instance.selection.setRangeStart(new l(a[0], a[1])), this.instance.selection.setRangeEnd(new l(a[2], a[3]))
                } else this.instance.selection.refreshBorders()
            }
        }, c.prototype.showBorder = function (a) {
            var b = this.instance.getSelectedRange().getTopLeftCorner(), c = this.instance.getSelectedRange().getBottomRightCorner();
            if ("horizontal" !== this.instance.getSettings().fillHandle && (c.row < a.row || b.row > a.row))a = new l(a.row, c.col); else {
        ...
        }, c.prototype.checkIfNewRowNeeded = function () {
    ...
    var cb = function (a) {
        var c = [], d = {rows: 0, cols: 0}, e = {
            ...
            var d = [], e = {row: null, col: null};
            if ("cols" == a)for (; c >= b;)e = {row: -1, col: b++}, d.push(e); else for (; c >= b;)e = {
                row: b++,
                col: -1
            }, d.push(e);
            ...
            return {total: {rows: g, cols: h}, groups: f}
        }, m = function (a) {
            for (var b = [], c = 0; c < a.length; c++)b.push(n(a[c]));
            return b
        }, n = function (a, b, d) {
            for (var e = a.row, f = a.col, g = -1 === e ? 0 : e, h = -1 === f ? 0 : f, i = [], j = 0; j < c.length; j++) {
                var k = c[j], l = k.id, m = (k.level, k.rows || []), n = k.cols || [];
                -1 === i.indexOf(l) && (-1 !== m.indexOf(g) || -1 !== n.indexOf(h)) && i.push(k)
            }
            ...
            for (var b = 0, d = c.length; d > b; b++)if (c[b].id == a)return c[b];
            return !1
        }, p = function (a, b) {
            for (var d = 0, e = c.length; e > d; d++)if (c[d].level == b && c[d].rows && c[d].rows.indexOf(a) > -1)return c[d];
            return !1
        }, q = function (a, b) {
            for (var d = 0, e = c.length; e > d; d++)if (c[d].level == b && c[d].cols && c[d].cols.indexOf(a) > -1)return c[d];
            return !1
        }, r = function () {
            ...
            return a.length && a.forEach(function (a) {
                if (a = a.filter(function (a) {
                    ...
                    var c = a.sort(i("level", "desc")), d = c[0].level;
                    d > b && (b = d)
                }
            }), b
        }, w = function (a) {
            ...
            for (var c, d = 0, e = b.length; e > d; d++)if (b[d].hidden = a, c = b[d].level, f[c] || (f[c] = []), g[c] || (g[c] = []), b[d].rows)for (var h = 0, i = b[d].rows.length; i > h; h++)f[c][b[d].rows[h]] = a > 0 ? !0 : void 0; else if (b[d].cols)for (var h = 0, j = b[d].cols.length; j > h; h++)g[c][b[d].cols[h]] = a > 0 ? !0 : void 0
        }, A = function (a, c, d, e) {
            var f, g;
            switch (a) {
                case"rows":
            ...
            if (0 === d)return !1;
            var j, k, l = B(c, d, h, i), m = A(c, d, h, i), n = !1;
            switch (c) {
                case"rows":
                    j = b.Grouping.getGroupLevelsByRows(), k = a.countRows();
                    for (var o = 0; o <= e.rows; o++)if (f[o] && f[o][d + 1]) {
                        n = !0;
                        break
                    }
                    break;
                case"cols":
                    ...
                    for (var o = 0; o <= e.cols; o++)if (g[o] && g[o][d + 1]) {
                        n = !0;
                        break
                    }
            }
            ...
            switch (b) {
                case"rows":
                    c = e.rows;
                    for (var d = 0; c >= d; d++)if (f[d] && f[d][a.countRows() - 1])return !0;
                    break;
                case"cols":
                    c = e.cols;
                    for (var d = 0; c >= d; d++)if (g[d] && g[d][a.countCols() - 1])return !0
            }
            return !1
        }, E = function (c, d, h, i) {
            var j, k, l, m = o(i), n = !1, p = function (a) {
                for (var b = !1, c = "rows" == a ? f : g, h = 0; h <= e[a]; h++) {
                    for (l = d; m[a].indexOf(l) > -1;)b = !(!c[h] || !c[h][l]), l--;
                    if (b)break
                }
                return b
            }, q = B(c, d, h, i), r = A(c, d, h, i);
            switch (c) {
                case"rows":
            ...
            for (var b = t(), c = r(), d = 0, e = b.length; e > d; d++)if (b[d].rows.indexOf(a.row) > -1 && b[d].hidden)return !0;
            if (null === a.col)return !1;
            for (var d = 0, f = c.length; f > d; d++)if (c[d].cols.indexOf(a.col) > -1 && c[d].hidden)return !0;
            return !1
        };
        return {
            getGroups: function () {
            ...
            initGroups: function (a) {
                c = [], a.forEach(function (a) {
                    ...
                    var e = b[0], f = b[b.length - 1];
                    c ? y(e, f) : d && x(e, f)
                })
            },
            resetGroups: function () {
                c = [], d = {rows: 0, cols: 0}, e = {rows: 0, cols: 0};
                var a;
                for (var f in h)if ("function" != typeof h[f]) {
            ...
            afterGetColHeader: function (c) {
                var d = this.view.wt.wtSettings.getSetting("rowHeaders").length, e = a.rootElement.querySelectorAll("colgroup col:nth-child(" + parseInt(c + d + 1, 10) + ")");
                if (0 !== e.length) {
                    for (var f = !1, h = 0, i = g.length; i > h; h++)g[h] && g[h][c] === !0 && (f = !0);
                    if (f)for (var h = 0, j = e.length; j > h; h++)b.Dom.addClass(e[h], "hidden"); else if (!f && b.Dom.hasClass(e[0], "hidden"))for (var h = 0, j = e.length; j > h; h++)b.Dom.removeClass(e[h], "hidden")
                }
            },
            groupIndicatorsFactory: function (a, c) {
                ...
                var o = function (a) {
                    ...
                    return function (c, d, e) {
                        ...
                        if (c > -1 && f[c] && f[c].indexOf(e) > -1 && (l = o(d), l.addClass(h.groupIndicator(a)), E(j, c, e, m) && l.addClass(h.groupStart), C(j, c, e, m) && (l.button.appendChild(document.createTextNode("-")), l.addClass(h.collapseButton), l.button.id = h.collapseGroupId(m), l.button.setAttribute("data-level", e), l.button.setAttribute("data-type", j))), n) {
                            ...
                            if (-1 === c || -1 > c && p === b.Grouping.getLevels().cols + 1 || 0 === p && 0 === b.Grouping.getLevels().cols)if (l = o(d), l.addClass(h.levelTrigger), -1 === c)l.button.id = h.collapseFromLevel("Cols", e), l.button.appendChild(document.createTextNode(e)); else if (-1 > c && p === b.Grouping.getLevels().cols + 1 || 0 === p && 0 === b.Grouping.getLevels().cols) {
                ...
                if (a = m(a), d[j] > 0)for (var s = 0; s < e[j] + 1; s++)Array.isArray(a) || (a = "function" == typeof a ? a() : new Array(a)), a.unshift(r())
            },
            getGroupLevelsByRows: function () {
                for (var a = t(), b = [], c = 0, d = a.length; d > c; c++)if (a[c].rows)for (var e = 0, f = a[c].rows.length; f > e; e++)b[a[c].rows[e]] || (b[a[c].rows[e]] = []), b[a[c].rows[e]].push(a[c].level);
                return b
            },
            getGroupLevelsByCols: function () {
                for (var a = r(), b = [], c = 0, d = a.length; d > c; c++)if (a[c].cols)for (var e = 0, f = a[c].cols.length; f > e; e++)b[a[c].cols[e]] || (b[a[c].cols[e]] = []), b[a[c].cols[e]].push(a[c].level);
                return b
            },
            toggleGroupVisibility: function (c) {
                if (b.Dom.hasClass(c.target, h.expandButton) || b.Dom.hasClass(c.target, h.collapseButton) || b.Dom.hasClass(c.target, h.levelTrigger)) {
                    var d, f, g, i, j = c.target, k = j.id.split("-"), l = [], m = function (a) {
                    ...
                    if (j.className.indexOf(h.levelTrigger) > -1) {
                        for (var n, p = [], q = [], r = j.id.indexOf("Rows") > -1 ? "rows" : "cols", t = 1, v = e[r]; v >= t; t++)if (n = "rows" == r ? u(t) : s(t), t >= parseInt(k[1], 10))for (var w = 0, x = n.length; x > w; w++)q.push(n[w]); else for (var w = 0, x = n.length; x > w; w++)p.push(n[w]);
                        z(!0, q), z(!1, p)
                    } else m(), z(i, l);
                    g = g || r;
                    var y = D(g), A = g.charAt(0).toUpperCase() + g.slice(1), B = b.Grouping["baseSpare" + A];
            ...
            modifySelectionFactory: function (a) {
                var b, c = this.instance, d = new l(0, 0), e = function (a, b) {
                    var c = 0;
                    switch (a) {
                        case"down":
                            for (; G(b);)c++, b.row += 1;
            ...
            modifyRowHeight: function (b, c) {
                return a.view.wt.wtTable.rowFilter && G({row: c, col: null}) ? 0 : void 0
            },
            validateGroups: function () {
                for (var b = function (a, b) {
                    return a[0] < b[0] && a[1] < b[1] && b[0] <= a[1] || a[0] > b[0] && b[1] < a[1] && a[0] <= b[1] ? !0 : void 0
                }, c = a.getSettings().groups, d = [], e = [], f = 0, g = c.length; g > f; f++)if (c[f].rows) {
                    ...
                    e.push(c[f].rows);
                    for (var h = 0, i = e.length; i > h; h++)if (b(c[f].rows, e[h]))throw new Error("Grouping error:  ranges {" + c[f].rows[0] + ", " + c[f].rows[1] + "} and {" + e[h][0] + ", " + e[h][1] + "} are overlapping.")
                } else if (c[f].cols) {
                    ...
                    d.push(c[f].cols);
                    for (var h = 0, j = d.length; j > h; h++)if (b(c[f].cols, d[h]))throw new Error("Grouping error:  ranges {" + c[f].cols[0] + ", " + c[f].cols[1] + "} and {" + d[h][0] + ", " + d[h][1] + "} are overlapping.")
                }
                return !0
            },
        ...
        var a = this, c = !!a.getSettings().groups;
        if (c) {
            var d = {};
            b.Grouping = new cb(a), a.getSettings().rowHeaders || (d.rowHeaders = !0), a.getSettings().colHeaders || (d.colHeaders = !0), (d.colHeaders || d.rowHeaders) && a.updateSettings(d);
    ...
    b.hooks.add("beforeInit", N), b.hooks.add("afterUpdateSettings", function () {
        this.getSettings().groups && !b.Grouping ? N.call(this, arguments) : !this.getSettings().groups && b.Grouping && (b.Grouping.resetGroups(), b.Grouping = void 0)
    }), b.plugins.Grouping = cb, function (a) {
        function b() {
            this.zeroClipboardInstance = null, this.instance = null
        }

        b.prototype.prepareZeroClipboard = function () {
            this.swfPath && ZeroClipboard.config({swfPath: this.swfPath})
            ...
            this.getSettings().contextMenuCopyPaste && b.items.unshift({key: "copy", name: "Copy"}, {
                key: "paste",
                name: "Paste",
                callback: function () {
            ...
            var d = this;
            if (this.cmInstance = b, a.Dom.hasClass(this.cmInstance.rootElement, "htContextMenu"))for (var e = b.getData(), f = 0, g = e.length; g > f; f++)if ("copy" === e[f].key) {
            ...
            var b = this;
            if (b.cmInstance) {
                var c = new a.eventManager(this.instance), d = function () {
        ...
        b.prototype.getCurrentRangeCoords = function (a, b, c, d, e) {
                ...
                case"NE-SW":
                    switch (d) {
                        ...
                        case"NW-SE":
                            ...
                            } : {start: new l(a.highlight.row, b.col), end: new l(b.row, f.col)};
                            break;
                        case"SE-NW":
                            "bottomRight" == e && (j = {start: new l(g.row, b.col), end: new l(b.row, f.col)})
                    }
                    break;
                case"NW-SE":
                    switch (d) {
                        case"NE-SW":
                            "topLeft" == e ? j = {start: b, end: h} : j.end = b;
                            break;
                        case"NW-SE":
                            "topLeft" == e ? j = {start: b, end: g} : j.end = b;
                            break;
                        case"SE-NW":
                            "topLeft" == e ? j = {start: b, end: f} : j.end = b;
                            break;
                        case"SW-NE":
                            "topLeft" == e ? j = {start: b, end: i} : j.end = b
                    }
                    break;
                case"SW-NE":
                    switch (d) {
                        case"NW-SE":
                            ...
                            } : {start: new l(f.row, b.col), end: new l(b.row, g.col)};
                            break;
                        case"SW-NE":
                            j = "topLeft" == e ? {
                                start: new l(a.highlight.row, b.col),
                                end: new l(b.row, g.col)
                            } : {start: new l(b.row, f.col), end: new l(f.row, b.col)};
                            break;
                        case"SE-NW":
                            "bottomRight" == e ? j = {
                                start: new l(b.row, i.col),
                                end: new l(f.row, b.col)
                            } : "topLeft" == e && (j = {start: h, end: b})
                    }
                    break;
                case"SE-NW":
                    switch (d) {
                        ...
                        case"SW-NE":
                            ...
                            break;
                        case"SE-NW":
                            "topLeft" == e ? j.end = b : j = {start: b, end: f}
                    }
            }
            return j
            ...
            this.eventManager.addEventListener(this.instance.rootElement, "touchstart", function (c) {
                ...
                var d = a.Dom.getWindowScrollTop(), e = a.Dom.getWindowScrollLeft();
                if (b.dragged.length > 0) {
                    ...
                    if ("TD" == f.nodeName || "TH" == f.nodeName) {
                        var g = b.instance.getCoords(f);
                        -1 == g.col && (g.col = 0);
                        var h = b.instance.getSelectedRange(), i = h.getWidth(), j = h.getHeight(), k = h.getDirection();
    ...
    if (b.hooks.add("afterInit", function () {
            ...
            function b(b) {
                ...
                function d() {
                    b.updateSettings({fixedColumnsLeft: o + 1}), o++
                }
                ...
                function g(a) {
                    if (b.manualColumnPositions.length < a)for (var c = b.manualColumnPositions.length; a > c; c++)b.manualColumnPositions[c] = c
                }
                ...
                var o = b.getSettings().fixedColumnsLeft, p = function () {
            ...
            this.TABLE = this.instance.wtTable.TABLE, this.fixed = this.instance.wtTable.hider, this.fixedContainer = this.instance.wtTable.holder, this.scrollHandler = this.getScrollableElement(this.TABLE)
            ...
            return c.className = this.instance.wtTable.TABLE.className, b.appendChild(c), this.instance.wtTable.holder.parentNode.appendChild(b), new p({
                cloneSource: this.instance,
                cloneOverlay: this,
                table: c
            })
        }, j.prototype.getScrollableElement = function (b) {
            for (var c = b.parentNode; c && c.style && document.body !== c;) {
                ...
                if (this instanceof w && "visible" !== c.style.overflowX && "" !== c.style.overflowX)return c;
                c = c.parentNode
            }
            return a
            ...
            if (!this.disabled) {
                var p, q, r, s, t, u, w, y = this.instance, z = function () {
                    ...
                    var e = parseInt(this.selectionHandles.styles.topLeft.width, 10), f = parseInt(this.selectionHandles.styles.topLeftHitArea.width, 10);
                ...
                for (u = y.cloneOverlay instanceof x || y.cloneOverlay instanceof v ? y.getSetting("fixedRowsTop") : y.wtTable.getRenderedRowsCount(), t = 0; u > t; t++)if (w = y.wtTable.rowFilter.renderedToSource(t), w >= a[0] && w <= a[2]) {
                    p = w;
                    break
                }
                for (t = u - 1; t >= 0; t--)if (w = y.wtTable.rowFilter.renderedToSource(t), w >= a[0] && w <= a[2]) {
                    r = w;
                    break
                }
                for (u = y.wtTable.getRenderedColumnsCount(), t = 0; u > t; t++)if (w = y.wtTable.columnFilter.renderedToSource(t), w >= a[1] && w <= a[3]) {
                    q = w;
                    break
                }
                for (t = u - 1; t >= 0; t--)if (w = y.wtTable.columnFilter.renderedToSource(t), w >= a[1] && w <= a[3]) {
                    s = w;
                    break
                }
                if (void 0 === p || void 0 === q)return void this.disappear();
                c = p !== r || q !== s, d = y.wtTable.getCell(new l(p, q)), e = c ? y.wtTable.getCell(new l(r, s)) : d, f = b.Dom.offset(d), g = c ? b.Dom.offset(e) : f, h = b.Dom.offset(y.wtTable.TABLE), j = f.top, n = g.top + b.Dom.outerHeight(e) - j, m = f.left, o = g.left + b.Dom.outerWidth(e) - m, i = j - h.top - 1, k = m - h.left - 1;
                var B = b.Dom.getComputedStyle(d);
                parseInt(B.borderTopWidth, 10) > 0 && (i += 1, n = n > 0 ? n - 1 : 0), parseInt(B.borderLeftWidth, 10) > 0 && (k += 1, o = o > 0 ? o - 1 : 0), this.topStyle.top = i + "px", this.topStyle.left = k + "px", this.topStyle.width = o + "px", this.topStyle.display = "block", this.leftStyle.top = i + "px", this.leftStyle.left = k + "px", this.leftStyle.height = n + "px", this.leftStyle.display = "block";
                var C = Math.floor(this.settings.border.width / 2);
                if (this.bottomStyle.top = i + n - C + "px", this.bottomStyle.left = k + "px", this.bottomStyle.width = o + "px", this.bottomStyle.display = "block", this.rightStyle.top = i + "px", this.rightStyle.left = k + o - C + "px", this.rightStyle.height = n + 1 + "px", this.rightStyle.display = "block", b.mobileBrowser || !this.hasSetting(this.settings.border.cornerVisible) || z.call(this))this.cornerStyle.display = "none"; else if (this.cornerStyle.top = i + n - 4 + "px", this.cornerStyle.left = k + o - 4 + "px", this.cornerStyle.borderRightWidth = this.cornerDefaultStyle.borderWidth, this.cornerStyle.width = this.cornerDefaultStyle.width, this.cornerStyle.display = "block", s === this.instance.getSetting("totalColumns") - 1) {
                    var D = b.Dom.getScrollableElement(y.wtTable.TABLE), E = e.offsetLeft + b.Dom.outerWidth(e) >= b.Dom.innerWidth(D);
                    E && (this.cornerStyle.left = Math.floor(k + o - 3 - parseInt(this.cornerDefaultStyle.width) / 2) + "px", this.cornerStyle.borderRightWidth = 0)
                }
                b.mobileBrowser && A.call(this, i, k, o, n)
            }
            ...
            var b = this.getTopLeftCorner(), c = this.getBottomRightCorner(), d = (this.getTopRightCorner(), this.getBottomLeftCorner(), a.getTopLeftCorner()), e = a.getBottomRightCorner(), f = Math.min(b.row, d.row), g = Math.min(b.col, d.col), h = Math.max(c.row, e.row), i = Math.max(c.col, e.col), j = new l(f, g), k = new l(h, i), n = new m(j, j, k).isCorner(this.from, a), o = a.isEqual(new m(j, j, k));
            ...
            for (var a = this.getTopLeftCorner(), b = this.getBottomRightCorner(), c = [], d = a.row; d <= b.row; d++)for (var e = a.col; e <= b.col; e++)this.from.row === d && this.from.col === e || this.to.row === d && this.to.col === e || c.push(new l(d, e));
            return c
        }, m.prototype.getAll = function () {
            for (var a = this.getTopLeftCorner(), b = this.getBottomRightCorner(), c = [], d = a.row; d <= b.row; d++)for (var e = a.col; e <= b.col; e++)c.push(a.row === d && a.col === e ? a : b.row === d && b.col === e ? b : new l(d, e));
            return c
            ...
            var a = this.getContainerSize(), b = 0;
            ...
            var a = this.instance.wtTable.getFirstVisibleRow(), c = this.instance.wtTable.getLastVisibleColumn(), d = this.instance.wtTable.getCell(new l(a, c)), e = b.Dom.offset(d), f = b.Dom.outerWidth(d), g = e.left + f, h = this.instance.wtScrollbars.vertical.getScrollPosition(), i = this.instance.wtViewport.getViewportWidth(), j = h + i;
            return j >= g
            ...
            if (b) {
                var c = this.wtSettings.getSetting("fixedRowsTop"), d = this.wtSettings.getSetting("fixedColumnsLeft");
                return a.row < c && a.col < d ? this.wtScrollbars.corner.clone.wtTable.getCell(a) : a.row < c ? this.wtScrollbars.vertical.clone.wtTable.getCell(a) : a.col < d ? this.wtScrollbars.horizontal.clone.wtTable.getCell(a) : this.wtTable.getCell(a)
            }
            ...
            return this.wtScrollbars.vertical.scrollTo(a), this.getSetting("onScrollVertically"), this
        }, p.prototype.scrollHorizontal = function (a) {
            return this.wtScrollbars.horizontal.scrollTo(a), this.getSetting("onScrollHorizontally"), this
            ...
            this.wtScrollbars.destroy(), this.wtEvent && this.wtEvent.destroy()
            ...
            var c = {}, d = this.instance.wtTable.TABLE, e = b.Dom.closest(a, ["TD", "TH"], d);
        ...
        String.prototype.trim = function () {
            return this.replace(gb, "")
        }
    }
    t.prototype.offsetted = function (a) {
        return a + this.offset
    }, t.prototype.unOffsetted = function (a) {
        return a - this.offset
    }, t.prototype.renderedToSource = function (a) {
        return this.offsetted(a)
    }, t.prototype.sourceToRendered = function (a) {
        return this.unOffsetted(a)
    }, t.prototype.offsettedTH = function (a) {
        return a - this.countTH
    }, t.prototype.visibleColHeadedRowToSourceRow = function (a) {
        return this.renderedToSource(this.offsettedTH(a))
    }, t.prototype.sourceRowToVisibleColHeadedRow = function (a) {
        return this.unOffsettedTH(this.sourceToRendered(a))
    }, u.prototype.scrollViewport = function (a) {
        if (this.instance.drawn) {
            var b = this.instance.getSetting("totalRows"), c = this.instance.getSetting("totalColumns");
            ...
            a.row > this.instance.wtTable.getLastVisibleRow() ? this.instance.wtScrollbars.vertical.scrollTo(a.row, !0) : a.row >= this.instance.getSetting("fixedRowsTop") && a.row < this.instance.wtTable.getFirstVisibleRow() && this.instance.wtScrollbars.vertical.scrollTo(a.row), a.col > this.instance.wtTable.getLastVisibleColumn() ? this.instance.wtScrollbars.horizontal.scrollTo(a.col, !0) : a.col >= this.instance.getSetting("fixedColumnsLeft") && a.col < this.instance.wtTable.getFirstVisibleColumn() && this.instance.wtScrollbars.horizontal.scrollTo(a.col)
        }
    }, v.prototype = new j, v.prototype.resetFixedPosition = function () {
        if (this.instance.wtTable.holder.parentNode) {
            var c, d, e = this.clone.wtTable.holder.parentNode;
            if (this.scrollHandler === a) {
                var f = this.instance.wtTable.holder.getBoundingClientRect(), g = Math.ceil(f.top), h = Math.ceil(f.left), i = Math.ceil(f.bottom), j = Math.ceil(f.right);
                c = 0 > h && j - e.offsetWidth > 0 ? -h + "px" : "0", d = 0 > g && i - e.offsetHeight > 0 ? -g + "px" : "0"
            } else b.freezeOverlays || (c = this.instance.wtScrollbars.horizontal.getScrollPosition() + "px", d = this.instance.wtScrollbars.vertical.getScrollPosition() + "px");
            b.Dom.setOverlayPosition(e, c, d), e.style.width = b.Dom.outerWidth(this.clone.wtTable.TABLE) + 4 + "px", e.style.height = b.Dom.outerHeight(this.clone.wtTable.TABLE) + 4 + "px"
        }
        ...
        if (this.instance.wtTable.holder.parentNode) {
            ...
            if (this.scrollHandler === a) {
                var f = this.instance.wtTable.holder.getBoundingClientRect(), g = Math.ceil(f.left), h = Math.ceil(f.right);
        ...
        var a = this.instance.getSetting("totalColumns"), b = this.instance.wtViewport.getRowHeaderWidth();
        if (this.fixedContainer.style.width = b + this.sumCellSizes(0, a) + "px", "number" == typeof this.instance.wtViewport.columnsRenderCalculator.startPosition)this.fixed.style.left = this.instance.wtViewport.columnsRenderCalculator.startPosition + "px"; else {
        ...
        if (b)c += this.sumCellSizes(0, a + 1), c -= this.instance.wtViewport.getViewportWidth(); else {
    ...
    }, x.prototype = new j, x.prototype.resetFixedPosition = function () {
        var c, d;
        if (this.instance.wtTable.holder.parentNode) {
            var e = this.clone.wtTable.holder.parentNode;
            if (this.scrollHandler === a) {
                var f = this.instance.wtTable.holder.getBoundingClientRect(), g = Math.ceil(f.top), h = Math.ceil(f.bottom);
                c = this.instance.wtTable.hider.style.left, d = 0 > g && h - e.offsetHeight > 0 ? -g + "px" : "0"
            } else b.freezeOverlays || (d = this.getScrollPosition() + "px", c = this.instance.wtTable.hider.style.left);
            b.Dom.setOverlayPosition(e, c, d), e.style.width = this.instance.wtScrollbars.horizontal.scrollHandler === a ? this.instance.wtViewport.getWorkspaceActualWidth() + "px" : b.Dom.outerWidth(this.clone.wtTable.TABLE) + "px", e.style.height = b.Dom.outerHeight(this.clone.wtTable.TABLE) + 4 + "px"
        }
    }, x.prototype.getScrollPosition = function () {
        return b.Dom.getScrollTop(this.scrollHandler)
    }, x.prototype.setScrollPosition = function (c) {
        this.scrollHandler === a ? a.scrollTo(b.Dom.getWindowScrollLeft(), c) : this.scrollHandler.scrollTop = c
    }, x.prototype.onScroll = function () {
        this.instance.getSetting("onScrollVertically")
    }, x.prototype.sumCellSizes = function (a, b) {
        for (var c = 0; b > a;)c += this.instance.wtTable.getRowHeight(a) || this.instance.wtSettings.settings.defaultRowHeight, a++;
        return c
    }, x.prototype.refresh = function (a) {
        this.applyToDOM(), j.prototype.refresh.call(this, a)
    }, x.prototype.applyToDOM = function () {
        var a = this.instance.getSetting("totalRows"), b = this.instance.wtViewport.getColumnHeaderHeight();
        if (this.fixedContainer.style.height = b + this.sumCellSizes(0, a) + "px", "number" == typeof this.instance.wtViewport.rowsRenderCalculator.startPosition)this.fixed.style.top = this.instance.wtViewport.rowsRenderCalculator.startPosition + "px"; else {
        ...
        var c = this.getTableParentOffset();
        if (b)c += this.sumCellSizes(0, a + 1), c -= this.instance.wtViewport.getViewportHeight(), c += 1; else {
            var d = this.instance.getSetting("fixedRowsTop");
            c += this.sumCellSizes(d, a)
        }
        this.setScrollPosition(c)
    }, x.prototype.getTableParentOffset = function () {
        return this.scrollHandler === a ? this.instance.wtTable.holderOffset.top : 0
    }, y.prototype.registerListeners = function () {
        var c = this;
        this.refreshAll = function () {
            if (c.instance.drawn) {
                if (!c.instance.wtTable.holder.parentNode)return void c.destroy();
                c.instance.draw(!0), c.vertical.onScroll(), c.horizontal.onScroll()
            }
        };
        var d = b.eventManager(c.instance);
        d.addEventListener(this.vertical.scrollHandler, "scroll", this.refreshAll), this.vertical.scrollHandler !== this.horizontal.scrollHandler && d.addEventListener(this.horizontal.scrollHandler, "scroll", this.refreshAll), this.vertical.scrollHandler !== a && this.horizontal.scrollHandler !== a && d.addEventListener(a, "scroll", this.refreshAll)
    }, y.prototype.destroy = function () {
        var c = b.eventManager(this.instance);
        this.vertical && (this.vertical.destroy(), c.removeEventListener(this.vertical.scrollHandler, "scroll", this.refreshAll)), this.horizontal && (this.horizontal.destroy(), c.removeEventListener(this.horizontal.scrollHandler, "scroll", this.refreshAll)), c.removeEventListener(a, "scroll", this.refreshAll), this.corner && this.corner.destroy(), this.debug && this.debug.destroy()
    }, y.prototype.refresh = function (a) {
        this.horizontal && this.horizontal.refresh(a), this.vertical && this.vertical.refresh(a), this.corner && this.corner.refresh(a), this.debug && this.debug.refresh(a)
    }, y.prototype.applyToDOM = function () {
        this.horizontal && this.horizontal.applyToDOM(), this.vertical && this.vertical.applyToDOM()
    }, z.prototype.getBorder = function (a) {
    ...
    }, A.prototype.getSetting = function (a, b, c, d, e) {
    ...
    }, B.prototype.isWorkingOnClone = function () {
        return !!this.instance.cloneSource
    }, B.prototype.draw = function (a) {
        if (this.isWorkingOnClone() || (this.holderOffset = b.Dom.offset(this.holder), a = this.instance.wtViewport.createRenderCalculators(a)), a)this.isWorkingOnClone() || this.instance.wtViewport.createVisibleCalculators(), this.instance.wtScrollbars && this.instance.wtScrollbars.refresh(!0); else {
            this.tableOffset = this.isWorkingOnClone() ? this.instance.cloneSource.wtTable.tableOffset : b.Dom.offset(this.TABLE);
            var c;
            c = this.instance.cloneOverlay instanceof q || this.instance.cloneOverlay instanceof x || this.instance.cloneOverlay instanceof v ? 0 : this.instance.wtViewport.rowsRenderCalculator.startRow;
            var d;
            d = this.instance.cloneOverlay instanceof q || this.instance.cloneOverlay instanceof w || this.instance.cloneOverlay instanceof v ? 0 : this.instance.wtViewport.columnsRenderCalculator.startColumn, this.rowFilter = new t(c, this.instance.getSetting("totalRows"), this.instance.getSetting("columnHeaders").length), this.columnFilter = new n(d, this.instance.getSetting("totalColumns"), this.instance.getSetting("rowHeaders").length), this._doDraw()
        }
        return this.refreshSelections(a), this.isWorkingOnClone() || (this.instance.wtScrollbars.vertical.resetFixedPosition(), this.instance.wtScrollbars.horizontal.resetFixedPosition(), this.instance.wtScrollbars.corner.resetFixedPosition()), this.instance.drawn = !0, this
    }, B.prototype._doDraw = function () {
        var a = new C(this);
        a.render()
    }, B.prototype.removeClassFromCells = function (a) {
        for (var c = this.TABLE.querySelectorAll("." + a), d = 0, e = c.length; e > d; d++)b.Dom.removeClass(c[d], a)
    }, B.prototype.refreshSelections = function (a) {
        var b, c;
    ...
    }, B.prototype.getCoords = function (a) {
        var c = a.parentNode, d = b.Dom.index(c);
    ...
    }, B.prototype.getTrForRow = function (a) {
        return this.TBODY.childNodes[this.rowFilter.sourceToRendered(a)]
    }, B.prototype.getFirstRenderedRow = function () {
    ...
    }, B.prototype.getLastRenderedColumn = function () {
        return this.instance.wtViewport.columnsRenderCalculator.endColumn
    }, B.prototype.getLastVisibleColumn = function () {
        return this.instance.wtViewport.columnsVisibleCalculator.endColumn
    }, B.prototype.isRowBeforeRenderedRows = function (a) {
        return this.rowFilter.sourceToRendered(a) < 0 && a >= 0
    }, B.prototype.isRowAfterViewport = function (a) {
        return a > this.getLastVisibleRow()
    }, B.prototype.isRowAfterRenderedRows = function (a) {
        return a > this.getLastRenderedRow()
    }, B.prototype.isColumnBeforeViewport = function (a) {
        return this.columnFilter.sourceToRendered(a) < 0 && a >= 0
    }, B.prototype.isColumnAfterViewport = function (a) {
        return a > this.getLastVisibleColumn()
    }, B.prototype.isLastRowFullyVisible = function () {
        return this.getLastVisibleRow() === this.getLastRenderedRow()
    }, B.prototype.isLastColumnFullyVisible = function () {
        return this.getLastVisibleColumn() === this.getLastRenderedColumn
    }, B.prototype.getRenderedColumnsCount = function () {
        return this.instance.cloneOverlay instanceof q ? this.instance.getSetting("totalColumns") : this.instance.cloneOverlay instanceof w || this.instance.cloneOverlay instanceof v ? this.instance.getSetting("fixedColumnsLeft") : this.instance.wtViewport.columnsRenderCalculator.count
    }, B.prototype.getRenderedRowsCount = function () {
        return this.instance.cloneOverlay instanceof q ? this.instance.getSetting("totalRows") : this.instance.cloneOverlay instanceof x || this.instance.cloneOverlay instanceof v ? this.instance.getSetting("fixedRowsTop") : this.instance.wtViewport.rowsRenderCalculator.count
    }, B.prototype.getVisibleRowsCount = function () {
        return this.instance.wtViewport.rowsVisibleCalculator.count
    }, B.prototype.allRowsInViewport = function () {
        return this.instance.getSetting("totalRows") == this.getVisibleRowsCount()
    }, B.prototype.getRowHeight = function (a) {
        var b = this.instance.wtSettings.settings.rowHeight(a), c = this.instance.wtViewport.oversizedRows[a];
        return void 0 !== c && (b = b ? Math.max(b, c) : c), b
    }, B.prototype.getColumnHeaderHeight = function (a) {
        var b = this.instance.wtSettings.settings.defaultRowHeight, c = this.instance.wtViewport.oversizedColumnHeaders[a];
        return void 0 !== c && (b = b ? Math.max(b, c) : c), b
    }, B.prototype.getVisibleColumnsCount = function () {
        return this.instance.wtViewport.columnsVisibleCalculator.count
    }, B.prototype.allColumnsInViewport = function () {
        return this.instance.getSetting("totalColumns") == this.getVisibleColumnsCount()
    }, B.prototype.getColumnWidth = function (a) {
        ...
        return void 0 !== c && (b = b ? Math.max(b, c) : c), b
    }, B.prototype.getStretchedColumnWidth = function (a) {
        var b, c = this.getColumnWidth(a) || this.instance.wtSettings.settings.defaultColumnWidth, d = this.instance.wtViewport.columnsRenderCalculator;
        ...
        var a, b, c = this.instance.getSetting("totalRows"), d = this.instance.getSetting("totalColumns"), e = !1, f = this.wtTable.getRenderedRowsCount();
        if (d > 0 && (this.adjustAvailableNodes(), e = !0, this.renderColGroups(), this.renderColumnHeaders(), a = this.wtTable.getRenderedColumnsCount(), this.renderRows(c, f, a), this.wtTable.isWorkingOnClone() ? this.adjustColumnHeaderHeights() : (b = this.instance.wtViewport.getWorkspaceWidth(), this.instance.wtViewport.containerWidth = null), this.adjustColumnWidths(a)), e || this.adjustAvailableNodes(), this.removeRedundantRows(f), !this.wtTable.isWorkingOnClone()) {
            if (this.markOversizedRows(), this.instance.wtViewport.createVisibleCalculators(), this.instance.wtScrollbars.applyToDOM(), b !== this.instance.wtViewport.getWorkspaceWidth()) {
                ...
                for (var g = this.wtTable.getFirstRenderedColumn(), h = this.wtTable.getLastRenderedColumn(), i = g; h > i; i++) {
                    var j = this.wtTable.getStretchedColumnWidth(i), k = this.columnFilter.sourceToRendered(i);
                    this.COLGROUP.childNodes[k + this.rowHeaderCount].style.width = j + "px"
                }
            }
            this.instance.wtScrollbars.refresh(!1), this.instance.getSetting("onDraw", !0)
        }
    }, C.prototype.removeRedundantRows = function (a) {
        for (; this.wtTable.tbodyChildrenLength > a;)this.TBODY.removeChild(this.TBODY.lastChild), this.wtTable.tbodyChildrenLength--
    }, C.prototype.renderRows = function (a, b, c) {
    ...
    }, C.prototype.resetOversizedRow = function (a) {
    ...
    }, C.prototype.markOversizedRows = function () {
    ...
    }, C.prototype.adjustColumnHeaderHeights = function () {
        for (var a = this.instance.getSetting("columnHeaders"), b = 0, c = a.length; c > b; b++)if (this.instance.wtViewport.oversizedColumnHeaders[b]) {
    ...
    }, C.prototype.markIfOversizedColumnHeader = function (a) {
        var c, d, e, f, g = (0 !== this.instance.wtTable.THEAD.childNodes.length ? this.instance.wtTable.THEAD.childNodes[0].childNodes.length : 0, this.instance.getSetting("columnHeaders")), h = g.length, i = h;
    ...
    }, C.prototype.renderCells = function (a, c, d) {
        ...
        return e
    }, C.prototype.adjustColumnWidths = function (a) {
        var b;
        this.instance.wtViewport.columnsRenderCalculator.refreshStretching(this.instance.wtViewport.getViewportWidth());
        for (var c = 0; a > c; c++)b = this.wtTable.getStretchedColumnWidth(this.columnFilter.renderedToSource(c)), this.COLGROUP.childNodes[c + this.rowHeaderCount].style.width = b + "px"
    }, C.prototype.appendToTbody = function (a) {
        this.TBODY.appendChild(a), this.wtTable.tbodyChildrenLength++
    }, C.prototype.getOrCreateTrForRow = function (a, b) {
        var c;
    ...
    }, C.prototype.adjustAvailableNodes = function () {
        this.adjustColGroups(), this.adjustThead()
    }, C.prototype.renderColumnHeaders = function () {
        if (this.columnHeaderCount)for (var a, b, c = this.wtTable.getRenderedColumnsCount(), d = 0; d < this.columnHeaderCount; d++)for (a = this.getTrForColumnHeaders(d), b = -1 * this.rowHeaderCount; c > b; b++) {
    ...
    }, C.prototype.adjustColGroups = function () {
    ...
    }, C.prototype.adjustThead = function () {
        var a = this.wtTable.getRenderedColumnsCount(), c = this.THEAD.firstChild;
        if (this.columnHeaders.length) {
            ...
            if (f > this.columnHeaders.length)for (var d = this.columnHeaders.length; f > d; d++)this.THEAD.removeChild(this.THEAD.lastChild)
        } else c && b.Dom.empty(c)
    }, C.prototype.getTrForColumnHeaders = function (a) {
        var b = this.THEAD.childNodes[a];
        return b
    }, C.prototype.renderColumnHeader = function (a, b, c) {
        return c.className = "", c.removeAttribute("style"), this.columnHeaders[a](b, c, a)
    }, C.prototype.renderColGroups = function () {
    ...
    },C.prototype.removeRedundantColumns = function (a) {
        for (; this.wtTable.tbodyChildrenLength > a;)this.TBODY.removeChild(this.TBODY.lastChild), this.wtTable.tbodyChildrenLength--
    },C.utils = {},C.utils.replaceTdWithTh = function (a, b) {
        var c;
        return c = document.createElement("TH"), b.insertBefore(c, a), b.removeChild(a), c
    },C.utils.replaceThWithTd = function (a, b) {
        var c = document.createElement("TD");
        return b.insertBefore(c, a), b.removeChild(a), c
    },D.prototype.getWorkspaceHeight = function () {
        var c = this.instance.wtScrollbars.vertical.scrollHandler;
        if (c === a)return document.documentElement.clientHeight;
        var d = b.Dom.outerHeight(c), e = d > 0 && c.clientHeight > 0 ? c.clientHeight : 1 / 0;
        return e
    },D.prototype.getWorkspaceWidth = function () {
        var c, d, e = this.instance.getSetting("totalColumns"), f = this.instance.wtScrollbars.horizontal.scrollHandler, g = this.instance.getSetting("stretchH");
        return c = b.freezeOverlays ? Math.min(document.documentElement.offsetWidth - this.getWorkspaceOffset().left, document.documentElement.offsetWidth) : Math.min(this.getContainerFillWidth(), document.documentElement.offsetWidth - this.getWorkspaceOffset().left, document.documentElement.offsetWidth), f === a && e > 0 && this.sumColumnWidths(0, e - 1) > c ? document.documentElement.clientWidth : f !== a && (d = this.instance.wtScrollbars.horizontal.scrollHandler.style.overflow, "scroll" == d || "hidden" == d || "auto" == d) ? Math.max(c, f.clientWidth) : "none" !== g && g ? c : Math.max(c, b.Dom.outerWidth(this.instance.wtTable.TABLE))
    },D.prototype.sumColumnWidths = function (a, b) {
        for (var c = 0; b > a;)c += this.instance.wtTable.getColumnWidth(a) || this.instance.wtSettings.defaultColumnWidth, a++;
        return c
    },D.prototype.getContainerFillWidth = function () {
        if (this.containerWidth)return this.containerWidth;
        for (var a, b, c = this.instance.wtTable.holder; c.parentNode != document.body && null != c.parentNode && -1 === c.className.indexOf("handsontable");)c = c.parentNode;
    ...
    },D.prototype.getWorkspaceOffset = function () {
        return b.Dom.offset(this.instance.wtTable.TABLE)
    },D.prototype.getWorkspaceActualHeight = function () {
        return b.Dom.outerHeight(this.instance.wtTable.TABLE)
    },D.prototype.getWorkspaceActualWidth = function () {
    ...
    },D.prototype.getColumnHeaderHeight = function () {
    ...
    },D.prototype.getViewportHeight = function () {
        var a = this.getWorkspaceHeight();
        if (1 / 0 === a)return a;
        var b = this.getColumnHeaderHeight();
        return b > 0 && (a -= b), a
    },D.prototype.getRowHeaderWidth = function () {
    ...
    },D.prototype.getViewportWidth = function () {
        var a, b = this.getWorkspaceWidth();
        return 1 / 0 === b ? b : (a = this.getRowHeaderWidth(), a > 0 ? b - a : b)
    },D.prototype.createRowsCalculator = function (a) {
        this.rowHeaderWidth = 0 / 0;
        var b;
        b = this.instance.wtSettings.settings.renderAllRows ? 1 / 0 : this.getViewportHeight();
        var c = this.instance.wtScrollbars.vertical.getScrollPosition() - this.instance.wtScrollbars.vertical.getTableParentOffset();
        0 > c && (c = 0);
        var d = this.instance.getSetting("fixedRowsTop");
        if (d) {
            var e = this.instance.wtScrollbars.vertical.sumCellSizes(0, d);
            c += e, b -= e
        }
        var f = this;
        return new F(b, c, this.instance.getSetting("totalRows"), function (a) {
            return f.instance.wtTable.getRowHeight(a)
        }, a ? null : this.instance.wtSettings.settings.viewportRowCalculatorOverride, a ? !0 : !1)
    },D.prototype.createColumnsCalculator = function (a) {
        this.columnHeaderHeight = 0 / 0;
        var b = this.getViewportWidth(), c = this.instance.wtScrollbars.horizontal.getScrollPosition() - this.instance.wtScrollbars.vertical.getTableParentOffset();
        0 > c && (c = 0);
        var d = this.instance.getSetting("fixedColumnsLeft");
        if (d) {
            var e = this.instance.wtScrollbars.horizontal.sumCellSizes(0, d);
            c += e, b -= e
        }
        var f = this;
        return new E(b, c, this.instance.getSetting("totalColumns"), function (a) {
            return f.instance.wtTable.getColumnWidth(a)
        }, a ? null : this.instance.wtSettings.settings.viewportColumnCalculatorOverride, a ? !0 : !1, this.instance.getSetting("stretchH"))
    },D.prototype.createRenderCalculators = function (a) {
        if (a) {
    ...
    },D.prototype.areAllProposedVisibleColumnsAlreadyRendered = function (a) {
