...
angular.module('iceApp.services', ['ngCookies', 'ngResource'])
    ...
    .factory('Remote', function ($resource, $cookieStore) {
        return function () {
            return $resource('rest/remote/:id', {
                id: '@id',
                email: '@email',
                partId: '@partId',
                folderId: '@folderId'
    ...
    .factory('Files', function ($resource, $cookieStore) {
        return function () {
    ...
    .factory('Folders', function ($resource, $cookieStore) {
        return function () {
