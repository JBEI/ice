...
<xsl:variable name="global.service-name">JBEI Registry</xsl:variable>
<xsl:variable name="global.binding-name">JBEI Registry</xsl:variable>
...
.page {
	border-bottom: 2px solid #185DA0;
	margin: 0;
